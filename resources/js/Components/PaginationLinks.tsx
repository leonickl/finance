        ...
        >
            ...
            <div className="flex flex-1 justify-between sm:hidden">
                {pagination.prev_page_url ? (
                    ...
                    <span className="relative inline-flex cursor-default items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium leading-5 text-gray-500 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-600">
                        Previous
                    </span>
                )}
                ...
                {pagination.next_page_url ? (
                    ...
                    <span className="relative ml-3 inline-flex cursor-default items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium leading-5 text-gray-500 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-600">
                        Next
                    </span>
                )}
            </div>
