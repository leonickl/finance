...
function aa(t, e, n) {
    for (let r = 0; ; r++) {
        ...
        if (o.content.size || i.content.size) {
            let s = aa(o.content, i.content, n + 1);
            if (s != null) return s;
        }
        n += o.nodeSize;
    }
...
function ca(t, e, n, r) {
    for (let o = t.childCount, i = e.childCount; ; ) {
        ...
        if (s.content.size || l.content.size) {
            let c = ca(s.content, l.content, n - 1, r - 1);
            if (c) return c;
        }
        (n -= a), (r -= a);
    }
...
var w = class t {
    ...
    findDiffEnd(e, n = this.size, r = e.size) {
        return ca(this, e, n, r);
    }
    findIndex(e) {
        if (e == 0) return wr(0, e);
        if (e == this.size) return wr(this.content.length, e);
        if (e > this.size || e < 0)
            throw new RangeError(`Position ${e} outside of fragment (${this})`);
        for (let n = 0, r = 0; ; n++) {
            let o = this.child(n),
                i = r + o.nodeSize;
            if (i >= e) return i == e ? wr(n + 1, i) : wr(n, r);
            r = i;
        }
    }
    toString() {
...
w.empty = new w([], 0);
var bi = { index: 0, offset: 0 };
function wr(t, e) {
    return (bi.index = t), (bi.offset = e), bi;
}
function kr(t, e) {
    if (t === e) return !0;
    ...
    if (n) {
        ...
        for (let r = 0; r < t.length; r++) if (!kr(t[r], e[r])) return !1;
    } else {
        for (let r in t) if (!(r in e) || !kr(t[r], e[r])) return !1;
...
var Bt = class extends Error {},
    M = class t {
        ...
        insertAt(e, n) {
            let r = da(this.content, e + this.openStart, n);
            return r && new t(r, this.openStart, this.openEnd);
        }
        removeBetween(e, n) {
            return new t(
                ua(this.content, e + this.openStart, n + this.openStart),
                this.openStart,
                this.openEnd,
            );
        }
        ...
        static fromJSON(e, n) {
            ...
            return new t(w.fromJSON(e, n.content), r, o);
        }
...
function ua(t, e, n) {
    ...
    return t.replaceChild(r, i.copy(ua(i.content, e - o - 1, n - o - 1)));
}
function da(t, e, n, r) {
...
function fa(t, e, n, r) {
    ...
    if (o == e.index(r) && r < t.depth - n.openStart) {
        ...
        if (!n.openStart && !n.openEnd && t.depth == r && e.depth == r) {
            ...
            let { start: s, end: l } = Hh(n, t);
            return Lt(i, pa(t, s, l, e, r));
        }
    else return Lt(i, Cr(t, e, r));
}
function ha(t, e) {
...
function On(t, e, n, r) {
    ...
    t &&
        ((i = t.index(n)),
        t.depth > n ? i++ : t.textOffset && (It(t.nodeAfter, r), i++));
    for (let l = i; l < s; l++) It(o.child(l), r);
...
function pa(t, e, n, r, o) {
    let i = t.depth > o && wi(t, e, o + 1),
        s = r.depth > o && wi(n, r, o + 1),
        l = [];
    return (
        On(null, t, o, l),
        i && s && e.index(o) == n.index(o)
            ? (ha(i, s), It(Lt(i, pa(t, e, n, r, o + 1)), l))
            : (i && It(Lt(i, Cr(t, e, o + 1)), l),
              On(e, n, o, l),
              s && It(Lt(s, Cr(n, r, o + 1)), l)),
        On(r, null, o, l),
        new w(l)
    );
}
function Cr(t, e, n) {
    let r = [];
    if ((On(null, t, n, r), t.depth > n)) {
        let o = wi(t, e, n + 1);
        It(Lt(o, Cr(t, e, n + 1)), r);
    }
    return On(e, null, n, r), new w(r);
}
function Hh(t, e) {
    let n = e.depth - t.openStart,
        o = e.node(n).copy(t.content);
    for (let i = n - 1; i >= 0; i--) o = e.node(i).copy(w.from(o));
    return {
...
var Mr = class t {
        ...
        static resolveCached(e, n) {
            ...
            else Zl.set(e, (r = new Si()));
            let o = (r.elts[r.i] = t.resolve(e, n));
            return (r.i = (r.i + 1) % Fh), o;
        }
    },
    Si = class {
        constructor() {
    ...
    le = class t {
        constructor(e, n, r, o = V.none) {
            (this.type = e),
                (this.attrs = n),
                (this.marks = o),
                (this.content = r || w.empty);
        }
        get children() {
        ...
        hasMarkup(e, n, r) {
            return (
                this.type == e &&
                kr(this.attrs, n || e.defaultAttrs || $h) &&
                V.sameSet(this.marks, r || V.none)
            );
        }
        copy(e = null) {
        ...
        slice(e, n = this.content.size, r = !1) {
            if (e == n) return M.empty;
            let o = this.resolve(e),
                i = this.resolve(n),
                s = r ? 0 : o.sharedDepth(n),
                l = o.start(s),
                c = o.node(s).content.cut(o.pos - l, i.pos - l);
            return new M(c, o.depth - s, i.depth - s);
        }
        replace(e, n, r) {
            return zh(this.resolve(e), this.resolve(n), r);
        }
        nodeAt(e) {
            for (let n = this; ; ) {
        ...
        canReplace(e, n, r = w.empty, o = 0, i = r.childCount) {
        ...
        toJSON() {
            ...
            return (
                ...
                this.marks.length &&
                    (e.marks = this.marks.map((n) => n.toJSON())),
                e
            );
        }
        static fromJSON(e, n) {
...
var ki = class t extends le {
    ...
    toString() {
        return this.type.spec.toDebugString
            ...
            : ma(this.marks, JSON.stringify(this.text));
    }
    get textContent() {
        return this.text;
    }
...
function Jh(t) {
    ...
    function n(r) {
        ...
        let i = (e[r.join(",")] = new Ht(r.indexOf(t.length - 1) > -1));
...
function Sa(t, e) {
    let n = Object.create(null);
    if (e) for (let r in e) n[r] = new Mi(t, r, e[r]);
    return n;
}
var vr = class t {
    constructor(e, n, r) {
        (this.name = e),
            ...
            (this.attrs = Sa(e, r.attrs)),
            (this.defaultAttrs = ba(this.attrs)),
    ...
    computeAttrs(e) {
        return !e && this.defaultAttrs ? this.defaultAttrs : xa(this.attrs, e);
    }
    create(e = null, n, r) {
        if (this.isText)
            throw new Error("NodeType.create can't construct text nodes");
        return new le(this, this.computeAttrs(e), w.from(n), V.setFrom(r));
    }
    createChecked(e = null, n, r) {
        return (
            (n = w.from(n)),
            this.checkContent(n),
            new le(this, this.computeAttrs(e), n, V.setFrom(r))
        );
    }
    createAndFill(e = null, n, r) {
        ...
        let o = this.contentMatch.matchFragment(n),
            i = o && o.fillBefore(w.empty, !0);
        return i ? new le(this, e, n.append(i), V.setFrom(r)) : null;
    }
    validContent(e) {
    ...
    checkAttrs(e) {
        wa(this.attrs, e, "node", this.name);
    }
    allowsMarkType(e) {
...
var Mi = class {
    ...
    Rn = class t {
        ...
        checkAttrs(e) {
            wa(this.attrs, e, "mark", this.name);
        }
        excludes(e) {
    ...
    sn = class {
        constructor(e) {
            ...
            (n.nodes = yi.from(e.nodes)),
                (n.marks = yi.from(e.marks || {})),
                (this.nodes = vr.compile(this.spec.nodes, this)),
                (this.marks = Rn.compile(this.spec.marks, this));
            let r = Object.create(null);
            for (let o in this.nodes) {
                if (o in this.marks)
                    throw new RangeError(
                        o + " can not be both a node and a mark",
                    );
                let i = this.nodes[o],
                    s = i.spec.content || "",
                    l = i.spec.marks;
            ...
            for (let o in this.marks) {
                let i = this.marks[o],
                    s = i.spec.excludes;
                i.excluded =
                    s == null ? [i] : s == "" ? [] : na(this, s.split(" "));
            }
            (this.nodeFromJSON = (o) => le.fromJSON(this, o)),
                (this.markFromJSON = (o) => V.fromJSON(this, o)),
        ...
        text(e, n) {
            ...
            return new ki(r, r.defaultAttrs, e, V.setFrom(n));
        }
        mark(e, n) {
...
var Ue = class t {
        ...
        parse(e, n = {}) {
            let r = new Tr(this, n, !1);
            return r.addAll(e, V.none, n.from, n.to), r.finish();
        }
        parseSlice(e, n = {}) {
            let r = new Tr(this, n, !0);
            return r.addAll(e, V.none, n.from, n.to), M.maxOpen(r.finish());
        }
        matchTag(e, n, r) {
            for (
...
var on = class {
        constructor(e, n, r, o, i, s) {
            (this.type = e),
                ...
                (this.options = s),
                (this.content = []),
                (this.activeMarks = V.none),
                (this.match = i || (s & Nn ? null : e.contentMatch));
        }
        findWrapping(e) {
            if (!this.match) {
                if (!this.type) return [];
        ...
        finish(e) {
            ...
            return (
                !e &&
                    this.match &&
                    (n = n.append(this.match.fillBefore(w.empty, !0))),
        ...
        inlineContext(e) {
            return this.type
                ...
                : this.content.length
                  ...
                  : e.parentNode &&
                    !ka.hasOwnProperty(e.parentNode.nodeName.toLowerCase());
        }
    },
    Tr = class {
        constructor(e, n, r) {
            ...
            let o = n.topNode,
                i,
                s = ra(null, n.preserveWhitespace, 0) | (r ? Nn : 0);
            o
                ? (i = new on(
                      o.type,
                      o.attrs,
                ...
                : r
                  ? (i = new on(null, null, V.none, !0, null, s))
                  : (i = new on(
        ...
        addTextNode(e, n) {
            let r = e.nodeValue,
                ...
                i =
                    o.options & vi
                        ? "full"
                        : this.localPreserveWS || (o.options & Dn) > 0;
            if (
                i === "full" ||
                o.inlineContext(e) ||
                /[^ \t\r\n\u000c]/.test(r)
...
`,
        ...
        addElement(e, n, r) {
            ...
            let s = e.nodeName.toLowerCase(),
                l;
            Ca.hasOwnProperty(s) && this.parser.normalizeLists && Zh(e);
            let a =
                (this.options.ruleFromNode && this.options.ruleFromNode(e)) ||
                (l = this.parser.matchTag(e, this, r));
            e: if (a ? a.ignore : Qh.hasOwnProperty(s))
...
`),
            ...
            if (o) {
                ...
                for (let l of o.concat(e.marks))
                    (i.type
                        ...
                        : ia(l.type, e.type)) && (s = l.addToSet(s));
        ...
        enterInner(e, n, r, o = !1, i) {
            ...
            let l = ra(e, i, s.options);
            s.options & Nn && s.content.length == 0 && (l |= Nn);
            let a = V.none;
            return (
                (r = r.filter((c) =>
                    (s.type ? s.type.allowsMarkType(c.type) : ia(c.type, e))
                        ? ((a = c.addToSet(a)), !1)
                        : !0,
                )),
        ...
        textblockFromContext() {
            ...
            if (e)
                for (let n = e.depth; n >= 0; n--) {
                    let r = e
                        .node(n)
                        .contentMatchAt(e.indexAfter(n)).defaultType;
        ...
        let i = [],
            s = (l) => {
                ...
                for (let a = 0; a < l.edgeCount; a++) {
                    ...
                    if (c == e || (i.indexOf(u) < 0 && s(u))) return !0;
                }
            };
...
var it = class t {
    ...
    serializeFragment(e, n = {}, r) {
        r || (r = xi(n).createDocumentFragment());
        let o = r,
            i = [];
        return (
            e.forEach((s) => {
    ...
    serializeMark(e, n, r = {}) {
        ...
        return o && Sr(xi(r), o(e, n), null, e.attrs);
    }
...
function tp(t) {
    let e = la.get(t);
    return e === void 0 && la.set(t, (e = np(t))), e;
}
function np(t) {
    let e = null;
    function n(r) {
...
function Sr(t, e, n, r) {
    ...
    let l,
        a = n ? t.createElementNS(n, o) : t.createElement(o),
        c = e[1],
        u = 1;
    ...
    for (let d = u; d < e.length; d++) {
        ...
        if (f === 0) {
            ...
            let { dom: h, contentDOM: p } = Sr(t, f, n, r);
...
var Ea = 1,
    ...
    Ln = class {
        ...
        get deletedBefore() {
            return (this.delInfo & (Ea | Ar)) > 0;
        }
        get deletedAfter() {
            return (this.delInfo & (Oa | Ar)) > 0;
        }
        get deletedAcross() {
            ...
            for (let l = 0; l < this.ranges.length; l += 3) {
                ...
                if (e <= d) {
                    let f = c ? (e == a ? -1 : e == d ? 1 : n) : n,
                        h = a + o + (f < 0 ? 0 : u);
                    if (r) return h;
                    let p = e == (n < 0 ? a : d) ? null : rp(l / 3, e - a),
                        m = e == a ? Oa : e == d ? Ea : Ar;
                    return (
                        (n < 0 ? e != a : e != d) && (m |= Na), new Ln(h, m, p)
                    );
                }
                o += u - c;
            }
            return r ? e + o : new Ln(e + o, 0, null);
        }
        touches(e, n) {
            let r = 0,
                o = Ma(n),
...
var Bn = class t {
        ...
        appendMappingInverted(e) {
            for (
                let n = e.maps.length - 1,
                    r = this._maps.length + e._maps.length;
                n >= 0;
                n--
            ) {
                let o = e.getMirror(n);
    ...
    ae = class {
        ...
        static jsonID(e, n) {
            ...
            return (Ti[e] = n), (n.prototype.jsonID = e), n;
        }
    },
    ce = class t {
        constructor(e, n) {
...
function Ri(t, e, n) {
    ...
    for (let o = 0; o < t.childCount; o++) {
        let i = t.child(o);
        i.content.size && (i = i.copy(Ri(i.content, e, i))),
            i.isInline && (i = e(i, n, o)),
            r.push(i);
    }
    return w.fromArray(r);
}
var zn = class t extends ae {
    constructor(e, n, r) {
...
ae.jsonID("addNodeMark", Hn);
var ln = class t extends ae {
    constructor(e, n) {
        super(), (this.pos = e), (this.mark = n);
    }
    apply(e) {
...
ae.jsonID("removeNodeMark", ln);
var pe = class t extends ae {
    ...
    apply(e) {
        return this.structure && Oi(e, this.from, this.to)
    ...
    static fromJSON(e, n) {
        ...
        return new t(n.from, n.to, M.fromJSON(e, n.slice), !!n.structure);
    }
};
ae.jsonID("replace", pe);
var ne = class t extends ae {
    ...
    apply(e) {
        if (
            this.structure &&
            (Oi(e, this.from, this.gapFrom) || Oi(e, this.gapTo, this.to))
        )
    ...
    static fromJSON(e, n) {
        ...
        return new t(
            ...
            n.gapFrom,
            n.gapTo,
            M.fromJSON(e, n.slice),
            n.insert,
            !!n.structure,
        );
    }
};
ae.jsonID("replaceAround", ne);
function Oi(t, e, n) {
    let r = t.resolve(e),
        o = n - e,
        i = r.depth;
            ...
            for (let m = 0; m < d.length; m++)
                d[m].isInSet(p) ||
                    (s && s.to == f && s.mark.eq(d[m])
                        ? (s.to = h)
                        : o.push((s = new lt(f, h, d[m]))));
            l && l.to == f ? (l.to = h) : i.push((l = new zn(f, h, r)));
        }
    }),
...
function Di(t, e, n, r = n.contentMatch, o = !0) {
    ...
    for (let a = 0; a < i.childCount; a++) {
        ...
        if (!d) s.push(new pe(l, u, M.empty));
        else {
            r = d;
            for (let f = 0; f < c.marks.length; f++)
                n.allowsMarkType(c.marks[f].type) ||
                    t.step(new lt(l, u, c.marks[f]));
            if (o && c.isText && n.whitespace != "pre") {
                ...
                for (; (f = h.exec(c.text)); )
                    p ||
                        (p = new M(
                            w.from(n.schema.text(" ", n.allowedMarks(c.marks))),
                            0,
                            0,
                        )),
                        s.push(
...
function at(t) {
    ...
    for (let r = t.depth; ; --r) {
        ...
        if (r == 0 || o.type.spec.isolating || !lp(o, i, s)) break;
    }
    return null;
}
function ap(t, e, n) {
    ...
    for (let p = i, m = !1; p > n; p--)
        m || r.index(p) > 0
            ? ((m = !0), (u = w.from(r.node(p).copy(u))), d++)
            : a--;
    let f = w.empty,
        h = 0;
    for (let p = i, m = !1; p > n; p--)
        m || o.after(p + 1) < o.end(p)
            ? ((m = !0), (f = w.from(o.node(p).copy(f))), h++)
            : c++;
    t.step(new ne(a, c, s, l, new M(u.append(f), d, h), u.size - d, !0));
}
function cn(t, e, n = null, r = t) {
    let o = cp(t, e),
        i = o && up(r, e);
    return i ? o.map(va).concat({ type: e, attrs: n }).concat(i.map(va)) : null;
}
function va(t) {
...
function dp(t, e, n) {
    ...
    let o = e.start,
        i = e.end;
    t.step(new ne(o, i, o, i, new M(r, 0, 0), n.length, !0));
}
function fp(t, e, n, r, o) {
    ...
    t.doc.nodesBetween(e, n, (s, l) => {
        ...
        if (
            s.isTextblock &&
            !s.hasMarkup(r, a) &&
            hp(t.doc, t.mapping.slice(i).map(l), r)
        ) {
            let c = null;
            ...
            c === !1 && Da(t, s, l, i),
                Di(t, t.mapping.slice(i).map(l, 1), r, void 0, c === null);
            let u = t.mapping.slice(i),
                d = u.map(l, 1),
                f = u.map(l + s.nodeSize, 1);
            return (
                t.step(
                    new ne(
                        d,
                        ...
                        d + 1,
                        f - 1,
                        new M(w.from(r.create(a, null, s.marks)), 0, 0),
                        1,
                        !0,
                    ),
                ),
...
function mp(t, e, n = 1, r) {
    let o = t.doc.resolve(e),
        i = w.empty,
        s = w.empty;
    for (let l = o.depth, a = o.depth - n, c = n - 1; l > a; l--, c--) {
        i = w.from(o.node(l).copy(i));
        let u = r && r[c];
        s = w.from(u ? u.type.create(u.attrs, s) : o.node(l).copy(s));
    }
    t.step(new pe(e, e, new M(i.append(s), n, n), !0));
}
function Ne(t, e) {
    let n = t.resolve(e),
        r = n.index();
    return Pa(n.nodeBefore, n.nodeAfter) && n.parent.canReplace(r, r + 1);
}
function gp(t, e) {
...
function Ft(t, e, n = -1) {
    ...
    for (let o = r.depth; ; o--) {
        ...
        if (
            ...
            i && !i.isTextblock && Pa(i, s) && r.node(o).canReplace(l, l + 1))
        )
            return e;
        if (o == 0) break;
...
function yp(t, e, n) {
    ...
    if (r === !1) {
        ...
        Da(t, u.node(), u.before(), l);
    }
    s.inlineContent &&
        Di(t, e + n - 1, s, i.node().contentMatchAt(i.index()), r == null);
    let a = t.mapping.slice(l),
        c = a.map(e - n);
    if ((t.step(new pe(c, a.map(e + n, -1), M.empty, !0)), r === !0)) {
        let u = t.doc.resolve(c);
        Ra(t, u.node(), u.before(), t.steps.length);
    }
    return t;
}
function bp(t, e, n) {
...
function Fn(t, e, n = e, r = M.empty) {
    if (e == n && !r.size) return null;
    let o = t.resolve(e),
        i = t.resolve(n);
    return Ia(o, i, r) ? new pe(e, n, r) : new Ni(o, i, r).fit();
}
function Ia(t, e, n) {
    return (
        !n.openStart &&
...
var Ni = class {
    ...
    fit() {
        ...
        let a = new M(i, s, l);
        return e > -1
            ? new ne(r.pos, e, this.$to.pos, this.$to.end(), a, n)
        ...
        for (let n = 1; n <= 2; n++)
            for (let r = n == 1 ? e : this.unplaced.openStart; r >= 0; r--) {
                let o,
                    i = null;
                r
                    ? ((i = Ai(this.unplaced.content, r - 1).firstChild),
                      (o = i.content))
    ...
    dropNode() {
        ...
        if (o.childCount <= 1 && n > 0) {
            ...
            this.unplaced = new M(Pn(e, n - 1, 1), n - 1, i ? n - 1 : r);
        } else this.unplaced = new M(Pn(e, n, 1), n, r);
    }
    placeNodes({
        sliceDepth: e,
        frontierDepth: n,
        ...
        p || (h = -1),
            (this.placed = In(this.placed, n, w.from(u))),
        ...
        this.unplaced = p
            ...
            : new M(Pn(s.content, e, c), s.openStart, s.openEnd);
    }
    mustMoveInline() {
        ...
        if (
            !e.type.isTextblock ||
            !Ei(this.$to, this.$to.depth, e.type, e.match, !1) ||
    ...
    close(e) {
        ...
        n.fit.childCount && (this.placed = In(this.placed, n.depth, n.fit)),
            (e = n.move);
    ...
    openFrontierNode(e, n = null, r) {
        ...
        (o.match = o.match.matchType(e)),
            (this.placed = In(this.placed, this.depth, w.from(e.create(n, r)))),
            this.frontier.push({ type: e, match: e.contentMatch });
    }
    closeFrontierNode() {
        let n = this.frontier.pop().match.fillBefore(w.empty, !0);
        n.childCount &&
            (this.placed = In(this.placed, this.frontier.length, n));
    }
};
function Pn(t, e, n) {
    return e == 0
        ...
        : t.replaceChild(
              0,
              t.firstChild.copy(Pn(t.firstChild.content, e - 1, n)),
          );
}
function In(t, e, n) {
    return e == 0
        ...
        : t.replaceChild(
              t.childCount - 1,
              t.lastChild.copy(In(t.lastChild.content, e - 1, n)),
          );
}
function Ai(t, e) {
...
function La(t, e, n) {
    ...
    return (
        e > 1 &&
            (r = r.replaceChild(
                0,
                La(r.firstChild, e - 1, r.childCount == 1 ? n - 1 : 0),
            )),
        e > 0 &&
...
function Ei(t, e, n, r, o) {
    ...
    return l && !xp(n, i.content, s) ? l : null;
}
function xp(t, e, n) {
...
function Sp(t, e, n, r) {
    ...
    let o = t.doc.resolve(e),
        i = t.doc.resolve(n);
    if (Ia(o, i, r)) return t.step(new pe(e, n, r));
    let s = za(o, t.doc.resolve(n));
    ...
    for (let f = u - 1; f >= 0; f--) {
        let h = c[f],
            p = wp(h.type);
        if (p && !h.sameMarkup(o.node(Math.abs(l) - 1))) u = f;
            ...
            for (let m = 0; m < s.length; m++) {
                ...
                if (b.canReplaceWith(x, x, p.type, p.marks))
                    return t.replace(
                        o.before(g),
                        y ? i.after(g) : n,
                        new M(Ba(r.content, 0, r.openStart, h), h, r.openEnd),
                    );
            }
    }
...
function Ba(t, e, n, r, o) {
    if (e < n) {
        let i = t.firstChild;
        t = t.replaceChild(0, i.copy(Ba(i.content, e + 1, n, r, i)));
    }
    if (e > r) {
...
function kp(t, e, n, r) {
    if (!r.isInline && e == n && t.doc.resolve(e).parent.content.size) {
        let o = bp(t.doc, e, r.type);
        o != null && (e = n = o);
    }
    t.replaceRange(e, n, new M(w.from(r), 0, 0));
}
function Cp(t, e, n) {
...
var kt = class {
    ...
    replace(e, n = e, r = M.empty) {
        let o = Fn(this.doc, e, n, r);
        return o && this.step(o), this;
    }
    replaceWith(e, n, r) {
        return this.replace(e, n, new M(w.from(r), 0, 0));
    }
    delete(e, n) {
    ...
    lift(e, n) {
        return ap(this, e, n), this;
    }
    join(e, n = 1) {
        return yp(this, e, n), this;
    }
    wrap(e, n) {
        return dp(this, e, n), this;
    }
    setBlockType(e, n = e, r, o = null) {
        return fp(this, e, n, r, o), this;
    }
    setNodeMarkup(e, n, r = null, o) {
        return pp(this, e, n, r, o), this;
    }
    setNodeAttribute(e, n, r) {
        return this.step(new Er(e, n, r)), this;
    }
    setDocAttribute(e, n) {
    ...
    removeNodeMark(e, n) {
        ...
        if (n instanceof V) n.isInSet(r.marks) && this.step(new ln(e, n));
        else {
            let o = r.marks,
                i,
                s = [];
            for (; (i = n.isInSet(o)); )
                s.push(new ln(e, i)), (o = i.removeFromSet(o));
    ...
    addMark(e, n, r) {
        return ip(this, e, n, r), this;
    }
    removeMark(e, n, r) {
        return sp(this, e, n, r), this;
    }
    clearIncompatible(e, n, r) {
        return Di(this, e, n, r), this;
    }
};
var Pi = Object.create(null),
    E = class {
        constructor(e, n, r) {
            (this.$anchor = e),
                (this.$head = n),
                (this.ranges = r || [new dn(e.min(n), e.max(n))]);
        }
        get anchor() {
        ...
        replace(e, n = M.empty) {
            ...
            for (let l = 0; l < s.length; l++) {
                let { $from: a, $to: c } = s[l],
                    u = e.mapping.slice(i);
                e.replaceRange(u.map(a.pos), u.map(c.pos), l ? M.empty : n),
                    l == 0 &&
                        $a(
                            e,
                            i,
        ...
        replaceWith(e, n) {
            ...
            for (let i = 0; i < o.length; i++) {
                ...
                i
                    ? e.deleteRange(c, u)
                    : (e.replaceRangeWith(c, u, n),
                      $a(e, r, n.isInline ? -1 : 1));
            }
        }
        static findFrom(e, n, r = !1) {
            let o = e.parent.inlineContent
                ? new A(e)
                : un(e.node(0), e.parent, e.pos, e.index(), n, r);
            if (o) return o;
        ...
        static atStart(e) {
            return un(e, e, 0, 0, 1) || new be(e);
        }
        static atEnd(e) {
            return un(e, e, e.content.size, e.childCount, -1) || new be(e);
        }
        static fromJSON(e, n) {
            if (!n || !n.type)
        ...
        static jsonID(e, n) {
            ...
            return (Pi[e] = n), (n.prototype.jsonID = e), n;
        }
        getBookmark() {
...
var A = class t extends E {
    ...
    static between(e, n, r) {
        ...
        if (((!r || o) && (r = o >= 0 ? 1 : -1), !n.parent.inlineContent)) {
            let i = E.findFrom(n, r, !0) || E.findFrom(n, -r, !0);
            if (i) n = i.$head;
        ...
        return (
            e.parent.inlineContent ||
                (o == 0
                    ? (e = n)
                    : ((e = (E.findFrom(e, -r, !0) || E.findFrom(e, r, !0))
                          .$anchor),
                      e.pos < n.pos != o < 0 && (e = n))),
            new t(e, n)
        );
...
var Dr = class t {
    ...
    O = class t extends E {
        ...
        content() {
            return new M(w.from(this.node), 0, 0);
        }
        eq(e) {
...
var Li = class t {
        ...
        map(e) {
            ...
            return n ? new Dr(r, r) : new t(r);
        }
        resolve(e) {
            let n = e.resolve(this.anchor),
                r = n.nodeAfter;
            return r && O.isSelectable(r) ? new O(n) : E.near(n);
        }
    },
    be = class t extends E {
        constructor(e) {
...
function un(t, e, n, r, o, i = !1) {
    if (e.inlineContent) return A.create(t, n);
    for (
        let s = r - (o > 0 ? 0 : 1);
        ...
        if (l.isAtom) {
            if (!i && O.isSelectable(l))
                return O.create(t, n - (o < 0 ? l.nodeSize : 0));
        } else {
            let a = un(t, l, n + o, o < 0 ? l.childCount : 0, o, i);
            if (a) return a;
        }
        n += l.nodeSize * o;
    }
...
function $a(t, e, n) {
    ...
    if (r < e) return;
    let o = t.steps[r];
    if (!(o instanceof pe || o instanceof ne)) return;
    ...
    Bi = class extends kt {
        ...
        setSelection(e) {
            ...
            return (
                (this.curSelection = e),
                (this.curSelectionFor = this.steps.length),
                (this.updated = (this.updated | Va) & ~Rr),
        ...
        setStoredMarks(e) {
            return (this.storedMarks = e), (this.updated |= Rr), this;
        }
        ensureMarks(e) {
            return (
                V.sameSet(
        ...
        get storedMarksSet() {
            return (this.updated & Rr) > 0;
        }
        addStep(e, n) {
            super.addStep(e, n),
                (this.updated = this.updated & ~Rr),
                (this.storedMarks = null);
        }
        setTime(e) {
                ...
                n &&
                    (e = e.mark(
                        this.storedMarks ||
                            (r.empty
                                ? r.$from.marks()
                                : r.$from.marksAcross(r.$to) || V.none),
                    )),
                    ...
                    : this.deleteSelection();
            {
                ...
                return (
                    ...
                    this.selection.empty ||
                        this.setSelection(E.near(this.selection.$to)),
                    this
                );
            }
        }
...
var $t = class {
        constructor(e, n, r) {
            (this.name = e),
                (this.init = _a(n.init, r)),
                (this.apply = _a(n.apply, r));
        }
    },
    vp = [
        new $t("doc", {
    ...
    Pr = class t {
        ...
        static create(e) {
            let n = new $n(e.doc ? e.doc.type.schema : e.schema, e.plugins),
                r = new t(n);
        ...
        reconfigure(e) {
            let n = new $n(this.schema, e.plugins),
                r = n.fields,
                o = new t(n);
        ...
        static fromJSON(e, n, r) {
            ...
            let o = new $n(e.schema, e.plugins),
                i = new t(o);
            return (
                o.fields.forEach((s) => {
                    if (s.name == "doc") i.doc = le.fromJSON(e.schema, n.doc);
                    else if (s.name == "selection")
                        i.selection = E.fromJSON(i.doc, n.selection);
...
var N = class {
        constructor(e) {
            (this.spec = e),
                (this.props = {}),
                e.props && ja(e.props, this, this.props),
                (this.key = e.key ? e.key.key : Ka("plugin"));
        }
        getState(e) {
            return e[this.key];
        }
...
function Ka(t) {
    return t in Ii ? t + "$" + ++Ii[t] : ((Ii[t] = 0), t + "$");
}
var L = class {
    constructor(e = "key") {
        this.key = Ka(e);
...
var ue = function (t) {
    ...
    Wi = null,
    ut = function (t, e, n) {
        let r = Wi || (Wi = document.createRange());
    ...
    Jt = function (t, e, n, r) {
        return n && (Ua(t, e, n, r, -1) || Ua(t, e, n, r, 1));
    },
...
function Ep(t, e) {
    for (;;) {
        ...
        } else if (t.parentNode && !qn(t)) (e = ue(t)), (t = t.parentNode);
        else return null;
    }
}
function Op(t, e) {
    for (;;) {
        ...
        } else if (t.parentNode && !qn(t)) (e = ue(t) + 1), (t = t.parentNode);
        else return null;
    }
}
function Np(t, e, n) {
...
var Je = typeof navigator < "u" ? navigator : null,
    Ja = typeof document < "u" ? document : null,
    Et = (Je && Je.userAgent) || "",
    _i = /Edge\/(\d+)/.exec(Et),
    vc = /MSIE \d/.exec(Et),
    ji = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Et),
    ke = !!(vc || ji || _i),
    Tt = vc ? document.documentMode : ji ? +ji[1] : _i ? +_i[1] : 0,
    Ve = !ke && /gecko\/(\d+)/i.test(Et);
Ve && +(/Firefox\/(\d+)/.exec(Et) || [0, 0])[1];
var Ki = !ke && /Chrome\/(\d+)/.exec(Et),
    ge = !!Ki,
    Tc = Ki ? +Ki[1] : 0,
    xe = !ke && !!Je && /Apple Computer/.test(Je.vendor),
    yn = xe && (/Mobile\/\w+/.test(Et) || (!!Je && Je.maxTouchPoints > 2)),
    Re = yn || (Je ? /Mac/.test(Je.platform) : !1),
    Pp = Je ? /Win/.test(Je.platform) : !1,
    dt = /Android \d/.test(Et),
    Gn = !!Ja && "webkitFontSmoothing" in Ja.documentElement.style,
    Ip = Gn
    ...
    for (let s = n || t.dom; s; ) {
        ...
        if (
            ...
            e.left < c.left + ct(r, "left")
                ? (u = -(c.left - e.left + ct(o, "left")))
                : e.right > c.right - ct(r, "right") &&
                  (u = e.right - c.right + ct(o, "right")),
            u || d)
        )
        ...
        s = f == "absolute" ? s.offsetParent : gn(s);
    }
}
function zp(t) {
    ...
    return { refDOM: r, refTop: o, stack: Ac(t.dom) };
}
function Ac(t) {
    let e = [],
        n = t.ownerDocument;
...
function Hp({ refDOM: t, refTop: e, stack: n }) {
...
function Oc(t, e) {
    ...
    for (let u = t.firstChild, d = 0; u; u = u.nextSibling, d++) {
        ...
        else if (u.nodeType == 3) f = ut(u).getClientRects();
        else continue;
...
function jp(t, e) {
    ...
    if (!s || !t.dom.contains(s.nodeType != 1 ? s.parentNode : s)) {
        ...
        if (!ls(e, c) || ((s = Nc(t.dom, e, c)), !s)) return null;
    }
    if (xe) for (let c = s; r && c; c = gn(c)) c.draggable && (r = void 0);
    if (((s = Vp(s, e)), r)) {
        if (
            Ve &&
            r.nodeType == 1 &&
...
function Ct(t, e) {
    ...
    return Array.prototype.find.call(n, Ga) || t.getBoundingClientRect();
}
var Kp = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/;
function Rc(t, e, n) {
    let {
    ...
    if (r.nodeType == 3)
        if (
            s &&
            (Kp.test(r.nodeValue) || (n < 0 ? !o : o == r.nodeValue.length))
        ) {
            let a = Ct(ut(r, o, o), n);
            if (
                Ve &&
                ...
                let c = Ct(ut(r, o - 1, o - 1), -1);
                if (c.top == a.top) {
                    let u = Ct(ut(r, o, o + 1), -1);
                    if (u.top != a.top) return Vn(u, u.left < c.left);
                }
            }
            return a;
        } else {
                ...
                n < 0 && !o
                    ...
                    : n >= 0 && o == r.nodeValue.length
                      ...
                      : n < 0
                        ? a--
                        : c++,
                Vn(Ct(ut(r, a, c), u), u < 0)
            );
        }
    if (!t.state.doc.resolve(e - (i || 0)).parent.inlineContent) {
        if (i == null && o && (n < 0 || o == De(r))) {
            let a = r.childNodes[o - 1];
            if (a.nodeType == 1) return zi(a.getBoundingClientRect(), !1);
        }
        if (i == null && o < De(r)) {
            let a = r.childNodes[o];
            if (a.nodeType == 1) return zi(a.getBoundingClientRect(), !0);
        }
        return zi(r.getBoundingClientRect(), n >= 0);
    }
    if (i == null && o && (n < 0 || o == De(r))) {
        let a = r.childNodes[o - 1],
            c =
        ...
        let c = a
            ? a.nodeType == 3
                ...
                : a.nodeType == 1
                  ...
                  : null
            : null;
        if (c) return Vn(Ct(c, -1), !0);
    }
    return Vn(Ct(r.nodeType == 3 ? ut(r) : r, -n), n >= 0);
}
function Vn(t, e) {
...
function qp(t, e, n) {
    ...
    let o = r.parentOffset,
        ...
        l = t.domSelection();
    return l
        ? !Jp.test(r.parent.textContent) || !l.modify
            ? n == "left" || n == "backward"
                ? i
                : s
            : Dc(t, e, () => {
...
function Gp(t, e, n) {
    return Ya == e && Xa == n
        ...
        : ((Ya = e),
          (Xa = n),
          (Qa = n == "up" || n == "down" ? Up(t, e, n) : qp(t, e, n)));
}
var Pe = 0,
    Za = 1,
    Wt = 2,
    ...
    qt = class {
        ...
        localPosFromDOM(e, n, r) {
            ...
            let o;
            if (e == this.dom && this.contentDOM) o = n > ue(this.contentDOM);
            else if (
                this.contentDOM &&
...
`
                    ...
                    d =
                        m &&
                        (m.nodeName == "BR" || m.contentEditable == "false");
                }
            }
            if (
                Ve &&
            ...
            if (
                !(o || (d && xe)) &&
                Jt(l.node, l.offset, u.anchorNode, u.anchorOffset) &&
                Jt(a.node, a.offset, u.focusNode, u.focusOffset)
            )
                return;
            let f = !1;
            if ((c.extend || e == n) && !d) {
    ...
    bn = class t extends qt {
        ...
        slice(e, n, r) {
            let o = t.create(this.parent, this.mark, !0, r),
                i = this.children,
                s = this.size;
            n < s && (i = Yi(i, n, s, r)), e > 0 && (i = Yi(i, 0, e, r));
    ...
    At = class t extends qt {
        ...
        static create(e, n, r, o, i, s) {
            ...
            if (n.isText) {
                ...
                u ||
                    ({ dom: u, contentDOM: d } = it.renderSpec(
                        document,
                        n.type.spec.toDOM(n),
                        null,
                        n.attrs,
            ...
            return (
                (u = Lc(u, r, n)),
                c
                    ? (a = new Ji(e, n, r, o, u, d || null, f, c, i, s + 1))
                    : n.isText
                      ? new Lr(e, n, r, o, u, f, i)
                      : new t(e, n, r, o, u, d || null, f, i, s + 1)
            );
        }
        parseRule() {
        ...
        updateChildren(e, n) {
            ...
            Zp(
                ...
                (a.changed || this.dirty == Wt) &&
                    ...
                    Pc(this.contentDOM, this.children, e),
                    yn && em(this.dom));
        }
        localCompositionInfo(e, n) {
            let { from: r, to: o } = e.state.selection;
            if (
                !(e.state.selection instanceof A) ||
                r < n ||
            ...
            if (this.node.inlineContent) {
                let s = i.nodeValue,
                    l = tm(this.node.content, s, r - n, o - n);
        ...
        protectLocalComposition(e, { node: n, pos: r, text: o }) {
            ...
            let s = new Ui(this, i, n, o);
            e.input.compositionNodes.push(s),
                (this.children = Yi(this.children, r, r + o.length, e, s));
        }
        update(e, n, r, o) {
            return this.dirty == qe || !e.sameMarkup(this.node)
                ? !1
        ...
        updateOuterDeco(e) {
            if (zr(e, this.outerDeco)) return;
            let n = this.nodeDOM.nodeType != 1,
                r = this.dom;
            (this.dom = Ic(
                this.dom,
                this.nodeDOM,
                qi(this.outerDeco, this.node, n),
                qi(e, this.node, n),
            )),
                this.dom != r &&
...
function ec(t, e, n, r, o) {
    Lc(r, e, t);
    let i = new At(void 0, t, e, n, r, r, r, o, 0);
    return i.contentDOM && i.updateChildren(o, 0), i;
}
var Lr = class t extends At {
...
Wn.prototype = Object.create(null);
var _t = [new Wn()];
function qi(t, e, n) {
    if (t.length == 0) return _t;
    let r = n ? _t[0] : new Wn(),
        o = [r];
    for (let i = 0; i < t.length; i++) {
        let s = t[i].type.attrs;
        if (s) {
            s.nodeName && o.push((r = new Wn(s.nodeName)));
            for (let l in s) {
                let a = s[l];
                a != null &&
                    (n &&
                        o.length == 1 &&
                        o.push((r = new Wn(e.isInline ? "span" : "div"))),
                    l == "class"
...
function Lc(t, e, n) {
    return Ic(t, t, _t, qi(e, n, t.nodeType != 1));
}
function zr(t, e) {
    if (t.length != e.length) return !1;
...
var Gi = class {
    constructor(e, n, r) {
        (this.lock = n),
            ...
            (this.changed = !1),
            (this.top = e),
            (this.preMatch = Xp(e.node.content, e));
    }
    destroyBetween(e, n) {
        if (e != n) {
    ...
    syncToMarks(e, n, r) {
        ...
        for (; i < e.length; ) {
            ...
            if (l > -1)
                ...
                let a = bn.create(this.top, e[i], n, r);
    ...
    updateNodeAt(e, n, r, o, i) {
        ...
        return (
            s.dirty == qe && s.dom == s.contentDOM && (s.dirty = Wt),
            s.update(e, n, r, i)
    ...
    recreateWrapper(e, n, r, o, i, s) {
        if (
            ...
            return null;
        let l = At.create(this.top, n, r, o, i, s);
        if (l.contentDOM) {
    ...
    addNode(e, n, r, o, i) {
        let s = At.create(this.top, e, n, r, o, i);
    ...
    e: for (; o > 0; ) {
        ...
        for (;;)
            if (r) {
                ...
                if (c instanceof bn) (n = c), (r = c.children.length);
                else {
                    (l = c), r--;
                    break;
                }
...
function as(t, e = null) {
    ...
    if (jr(n)) {
        ...
        if (
            ...
            O.isSelectable(d) &&
            o.parent &&
            !(d.isInline && Np(n.focusNode, n.focusOffset, o.dom))
        ) {
            let f = o.posBefore;
            c = new O(s == f ? l : r.resolve(f));
        }
    } else {
        if (
            ...
            if (d < 0) return null;
            ([a, s] = f == t.state.selection.anchor ? [f, d] : [d, f]),
                (l = r.resolve(s));
...
function ft(t, e = !1) {
    ...
    if ((zc(t, n), !!Bc(t))) {
        ...
        if ((t.domObserver.disconnectSelection(), t.cursorWrapper)) rm(t);
        else {
            ...
            nc &&
                !(n instanceof A) &&
                (n.$from.parent.inlineContent || (i = rc(t, n.from)),
                !n.empty && !n.$from.parent.inlineContent && (s = rc(t, n.to))),
                ...
                n.visible
                    ...
                    : (t.dom.classList.add("ProseMirror-hideselection"),
                      "onselectionchange" in document && nm(t));
        }
...
function rc(t, e) {
    ...
    if (xe && o && o.contentEditable == "false") return Hi(o);
    if (
    ...
    e.addEventListener(
        ...
        (t.input.hideSelectionGuard = () => {
            (n.anchorNode != r || n.anchorOffset != o) &&
                ...
                setTimeout(() => {
                    (!Bc(t) || t.state.selection.visible) &&
                        t.dom.classList.remove("ProseMirror-hideselection");
                }, 20));
        }),
    );
...
function rm(t) {
    ...
    let r = t.cursorWrapper.dom,
        o = r.nodeName == "IMG";
    o ? n.setStart(r.parentNode, ue(r) + 1) : n.setStart(r, 0),
        n.collapse(!0),
        e.removeAllRanges(),
        e.addRange(n),
        !o &&
...
function zc(t, e) {
    if (e instanceof O) {
        ...
        n != t.lastSelectedViewDesc &&
            (ic(t), n && n.selectNode(), (t.lastSelectedViewDesc = n));
    } else ic(t);
}
function ic(t) {
...
function sc(t) {
    return t.editable && !t.hasFocus() ? !1 : Hc(t);
}
function Hc(t) {
...
function lc(t, e, n) {
    ...
    if (r instanceof A)
        if (n.indexOf("s") > -1) {
            ...
            return Mt(t, new A(r.$anchor, s));
        } else if (r.empty) {
            if (t.endOfTextblock(e > 0 ? "forward" : "backward")) {
                let o = Xi(t.state, e);
                return o && o instanceof O ? Mt(t, o) : !1;
        ...
        if (r instanceof O && r.node.isInline)
            return Mt(t, new A(e > 0 ? r.$to : r.$from));
        {
            let o = Xi(t.state, e);
            return o ? Mt(t, o) : !1;
        }
    ...
    for (
        ...
        if (r > 0) {
            ...
            if (Fc(n)) break;
            {
                ...
                for (; l && _n(l, -1); )
                    (o = n.parentNode), (i = ue(l)), (l = l.previousSibling);
                if (l) (n = l), (r = Hr(n));
                else {
    ...
    for (;;)
        if (r < o) {
            ...
            if (Fc(n)) break;
            {
                let l = n.nextSibling;
                for (; l && _n(l, 1); )
                    (i = l.parentNode), (s = ue(l) + 1), (l = l.nextSibling);
                if (l) (n = l), (r = 0), (o = Hr(n));
                else {
                    if (((n = n.parentNode), n == t.dom)) break;
                    r = o = 0;
...
function lm(t, e) {
    for (; t && e == t.childNodes.length && !qn(t); )
...
function am(t, e) {
    for (; t && !e && !qn(t); ) (e = ue(t)), (t = t.parentNode);
    for (; t && e; ) {
...
function Qi(t, e, n) {
    if (e.nodeType != 3) {
        ...
        (s = lm(e, n))
            ? ((e = s), (n = 0))
            : (i = am(e, n)) && ((e = i), (n = i.nodeValue.length));
    }
...
function ac(t, e) {
    ...
    if (!(ge || Pp) && n.parent.inlineContent) {
...
function cc(t, e, n) {
    ...
    if (!o.parent.inlineContent || t.endOfTextblock(e < 0 ? "up" : "down")) {
        let s = Xi(t.state, e);
        if (s && s instanceof O) return Mt(t, s);
    }
    if (!o.parent.inlineContent) {
        let s = e < 0 ? o : i,
            l = r instanceof be ? E.near(s, e) : E.findFrom(s, e);
        return l ? Mt(t, l) : !1;
    }
    return !1;
}
function uc(t, e) {
    if (!(t.state.selection instanceof A)) return !0;
...
function cm(t) {
    ...
    if (
        ...
        let r = e.firstChild;
        dc(t, r, "true"), setTimeout(() => dc(t, r, "false"), 20);
    }
    return !1;
}
function um(t) {
...
function dm(t, e) {
    let n = e.keyCode,
        r = um(e);
    if (n == 8 || (Re && n == 72 && r == "c")) return uc(t, -1) || hn(t, -1);
    if ((n == 46 && !e.shiftKey) || (Re && n == 68 && r == "c"))
        return uc(t, 1) || hn(t, 1);
    if (n == 13 || n == 27) return !0;
    if (n == 37 || (Re && n == 66 && r == "c")) {
        let o =
            n == 37 ? (ac(t, t.state.selection.from) == "ltr" ? -1 : 1) : -1;
        return lc(t, o, r) || hn(t, o);
    } else if (n == 39 || (Re && n == 70 && r == "c")) {
        let o = n == 39 ? (ac(t, t.state.selection.from) == "ltr" ? 1 : -1) : 1;
        return lc(t, o, r) || hn(t, o);
    } else {
        if (n == 38 || (Re && n == 80 && r == "c"))
            return cc(t, -1, r) || hn(t, -1);
        if (n == 40 || (Re && n == 78 && r == "c"))
            return cm(t) || cc(t, 1, r) || hn(t, 1);
        if (r == (Re ? "m" : "c") && (n == 66 || n == 73 || n == 89 || n == 90))
            return !0;
    }
    return !1;
}
function us(t, e) {
    ...
    let c = a.firstChild,
        u,
        d = 0;
    for (; c && c.nodeType == 1 && (u = jc[c.nodeName.toLowerCase()]); ) {
...
`,
    ...
    if (
        ...
        l = ym(fc(l, +u[1], +u[2]), u[4]);
    else if (
        ((l = M.maxOpen(hm(l.content, o), !0)), l.openStart || l.openEnd)
    ) {
        let d = 0,
            f = 0;
        for (
    ...
    for (let n = e.depth; n >= 0; n--) {
        ...
        if (
            (t.forEach((l) => {
                ...
                if (
                    (c =
                        s.length && i.length && Wc(a, i, l, s[s.length - 1], 0))
                )
                    s[s.length - 1] = c;
                else {
                    s.length &&
                        (s[s.length - 1] = _c(s[s.length - 1], i.length));
                    let u = Vc(l, a);
...
function Vc(t, e, n = 0) {
    for (let r = e.length - 1; r >= n; r--) t = e[r].create(null, w.from(t));
    return t;
}
function Wc(t, e, n, r, o) {
    if (o < t.length && o < e.length && t[o] == e[o]) {
        let i = Wc(t, e, n, r.lastChild, o + 1);
        ...
        if (
            ...
            return r.copy(r.content.append(w.from(Vc(n, t, o + 1))));
    }
}
function _c(t, e) {
    if (e == 0) return t;
    let n = t.content.replaceChild(t.childCount - 1, _c(t.lastChild, e - 1)),
        r = t.contentMatchAt(t.childCount).fillBefore(w.empty, !0);
...
function fc(t, e, n) {
    return (
        e < t.openStart &&
            (t = new M(
                Zi(t.content, -1, e, t.openStart, 0, t.openEnd),
                e,
                t.openEnd,
            )),
        n < t.openEnd &&
            (t = new M(Zi(t.content, 1, n, t.openEnd, 0, 0), t.openStart, n)),
        t
    );
}
var jc = {
...
function mm(t) {
    ...
    let n = Kc().createElement("div"),
        r = /<([a-z][^>\s]+)/i.exec(t),
        o;
    if (
        ((o = r && jc[r[1].toLowerCase()]) &&
            (t =
                o.map((i) => "<" + i + ">").join("") +
                t +
                o
...
function ym(t, e) {
    ...
    for (let l = r.length - 2; l >= 0; l -= 2) {
        ...
        (o = w.from(a.create(r[l + 1], o))), i++, s++;
    }
    return new M(o, i, s);
}
var we = {},
    Se = {},
    bm = { touchstart: !0, touchmove: !0 },
    es = class {
        constructor() {
            (this.shiftKey = !1),
                (this.mouseDown = null),
    ...
    for (let e in we) {
        ...
        t.dom.addEventListener(
            ...
            (t.input.eventHandlers[e] = (r) => {
                Sm(t, r) &&
                    !ds(t, r) &&
                    (t.editable || !(r.type in Se)) &&
                    n(t, r);
            }),
            bm[e] ? { passive: !0 } : void 0,
        );
    }
    xe && t.dom.addEventListener("input", () => null), ts(t);
}
function vt(t, e) {
    ...
    t.someProp("handleDOMEvents", (e) => {
        for (let n in e)
            t.input.eventHandlers[n] ||
                t.dom.addEventListener(
                    n,
                    (t.input.eventHandlers[n] = (r) => ds(t, r)),
                );
    });
}
function ds(t, e) {
...
Se.keydown = (t, e) => {
    ...
    if (
        ...
        if (
            ...
            yn && n.keyCode == 13 && !n.ctrlKey && !n.altKey && !n.metaKey)
        ) {
            let r = Date.now();
            ...
            t.someProp("handleKeyDown", (r) => r(t, n)) || dm(t, n)
                ? n.preventDefault()
                : vt(t, "key");
};
Se.keyup = (t, e) => {
...
function vm(t, e) {
    ...
    return o != null ? (mn(t, O.create(t.state.doc, o), "pointer"), !0) : !1;
}
function Tm(t, e, n, r, o) {
    return (
        fs(t, "handleClickOn", e, n, r) ||
...
function Am(t, e, n, r) {
    return (
        fs(t, "handleDoubleClickOn", e, n, r) ||
        t.someProp("handleDoubleClick", (o) => o(t, e, r))
    );
}
function Em(t, e, n, r) {
    return (
        fs(t, "handleTripleClickOn", e, n, r) ||
...
function Om(t, e, n) {
    ...
    if (e == -1)
        return r.inlineContent
            ? (mn(t, A.create(r, 0, r.content.size), "pointer"), !0)
            : !1;
    let o = r.resolve(e);
    for (let i = o.depth + 1; i > 0; i--) {
        let s = i > o.depth ? o.nodeAfter : o.node(i),
            l = o.before(i);
        if (s.inlineContent)
            mn(t, A.create(r, l + 1, l + 1 + s.content.size), "pointer");
        else if (O.isSelectable(s)) mn(t, O.create(r, l), "pointer");
        else continue;
        return !0;
    }
}
...
we.mousedown = (t, e) => {
    ...
    let s = t.posAtCoords(Kr(n));
    s &&
        (i == "singleClick"
            ? (t.input.mouseDown && t.input.mouseDown.done(),
              (t.input.mouseDown = new ns(t, s, n, !!r)))
            : (i == "doubleClick" ? Am : Em)(t, s.pos, s.inside, n)
              ? n.preventDefault()
              : vt(t, "pointer"));
};
var ns = class {
    constructor(e, n, r, o) {
        ...
        ((r.button == 0 &&
            ...
            (c instanceof O && c.from <= s && c.to > s)) &&
            (this.mightDrag = {
                node: i,
                pos: s,
    ...
    up(e) {
        ...
        this.view.state.doc != this.startDoc &&
            (n = this.view.posAtCoords(Kr(e))),
            this.updateAllowDefault(e),
            this.allowDefault || !n
                ? vt(this.view, "pointer")
                : Tm(this.view, n.pos, n.inside, e, this.selectNode)
                  ? e.preventDefault()
                  : e.button == 0 &&
                      (this.flushed ||
                          (xe &&
                    ...
                    ? (mn(
                          this.view,
                          E.near(this.view.state.doc.resolve(n.pos)),
                          "pointer",
                      ),
                      e.preventDefault())
                    : vt(this.view, "pointer");
...
we.touchstart = (t) => {
    (t.input.lastTouch = Date.now()), hs(t), vt(t, "pointer");
};
we.touchmove = (t) => {
    (t.input.lastTouch = Date.now()), vt(t, "pointer");
};
we.contextmenu = (t) => hs(t);
function Jc(t, e) {
    return t.composing
        ? !0
        : xe && Math.abs(e.timeStamp - t.input.compositionEndedAt) < 500
...
function qc(t, e) {
    clearTimeout(t.input.composingTimeout),
        e > -1 && (t.input.composingTimeout = setTimeout(() => Fr(t), e));
}
function Gc(t) {
    for (
        t.composing &&
        ((t.input.composing = !1), (t.input.compositionEndedAt = Dm()));
...
function Rm(t) {
    ...
    let n = Ep(e.focusNode, e.focusOffset),
        r = Op(e.focusNode, e.focusOffset);
    if (n && r && n != r) {
        let o = r.pmViewDesc,
...
var jn = (ke && Tt < 15) || (yn && Ip < 604);
we.copy = Se.cut = (t, e) => {
    let n = e,
        r = t.state.selection,
        o = n.type == "cut";
    if (r.empty) return;
    let i = jn ? null : n.clipboardData,
        s = r.content(),
        { dom: l, text: a } = us(t, s);
    i
        ? (n.preventDefault(),
...
function Lm(t, e) {
    ...
    setTimeout(() => {
        t.focus(),
            ...
            n
                ? Kn(t, r.value, null, o, e)
                : Kn(t, r.textContent, r.innerHTML, o, e);
    }, 50);
}
function Kn(t, e, n, r, o) {
    let i = $c(t, e, n, r, t.state.selection.$from);
    if (t.someProp("handlePaste", (a) => a(t, o, i || M.empty))) return !0;
    if (!i) return !1;
    let s = Im(i),
        l = s
...
Se.paste = (t, e) => {
    ...
    let r = jn ? null : n.clipboardData,
        o = t.input.shiftKey && t.input.lastKeyCode != 45;
    r && Kn(t, Yc(r), r.getData("text/html"), o, n)
        ? n.preventDefault()
        : Lm(t, n);
};
var $r = class {
...
we.dragstart = (t, e) => {
    ...
    let o = t.state.selection,
        i = o.empty ? null : t.posAtCoords(Kr(n)),
        s;
    if (
        !(i && i.pos >= o.from && i.pos <= (o instanceof O ? o.to - 1 : o.to))
    ) {
        if (r && r.mightDrag) s = O.create(t.state.doc, r.mightDrag.pos);
        else if (n.target && n.target.nodeType == 1) {
            let d = t.docView.nearestDesc(n.target, !0);
            d &&
                d.node.type.spec.draggable &&
                d != t.docView &&
                (s = O.create(t.state.doc, d.posBefore));
        }
    }
    let l = (s || t.state.selection).content(),
        { dom: a, text: c, slice: u } = us(t, l);
    (!n.dataTransfer.files.length || !ge || Tc > 120) &&
        n.dataTransfer.clearData(),
        n.dataTransfer.setData(jn ? "Text" : "text/html", a.innerHTML),
        (n.dataTransfer.effectAllowed = "copyMove"),
        jn || n.dataTransfer.setData("text/plain", c),
        (t.dragging = new $r(u, Xc(t, n), s));
};
we.dragend = (t) => {
    let e = t.dragging;
    window.setTimeout(() => {
...
Se.drop = (t, e) => {
    ...
    s
        ...
        : (s = $c(
              t,
              Yc(n.dataTransfer),
              jn ? null : n.dataTransfer.getData("text/html"),
              !1,
              i,
          ));
    let l = !!(r && Xc(t, n));
    if (t.someProp("handleDrop", (p) => p(t, n, s || M.empty, l))) {
        n.preventDefault();
        return;
    }
    if (!s) return;
    n.preventDefault();
    let a = s ? Nr(t.state.doc, i.pos, s) : i.pos;
    a == null && (a = i.pos);
    let c = t.state.tr;
    if (l) {
        let { node: p } = r;
    ...
    if (
        d &&
        O.isSelectable(s.content.firstChild) &&
        h.nodeAfter &&
        ...
        c.mapping.maps[c.mapping.maps.length - 1].forEach(
            ...
            c.setSelection(cs(t, h, c.doc.resolve(p)));
    }
...
we.beforeinput = (t, e) => {
    if (ge && dt && e.inputType == "deleteContentBackward") {
...
var Vr = class t {
        ...
        map(e, n, r, o) {
            ...
            return s ? null : new Y(i - r, i - r, this);
        }
        valid() {
            return !0;
        }
            ...
            return (
                ...
                (e instanceof t &&
                    ((this.spec.key && this.spec.key == e.spec.key) ||
                        (this.toDOM == e.toDOM && Un(this.spec, e.spec))))
            );
        }
        destroy(e) {
    ...
    Y = class t {
        ...
        static widget(e, n, r) {
            return new t(e, e, new Vr(n, r));
        }
        static inline(e, n, r, o) {
            return new t(e, n, new jt(r, o));
        }
        static node(e, n, r, o) {
            return new t(e, n, new rs(r, o));
        }
        get spec() {
    ...
    J = class t {
        constructor(e, n) {
            (this.local = e.length ? e : pn),
                (this.children = n.length ? n : pn);
        }
        static create(e, n) {
            return n.length ? _r(n, e, 0, Kt) : me;
        }
        find(e, n, r) {
            let o = [];
        ...
        addInner(e, n, r) {
            ...
            return new t(
                s.length ? this.local.concat(s).sort(Ut) : this.local,
                o || this.children,
            );
        }
        remove(e) {
        ...
        forChild(e, n) {
            ...
            for (let l = 0; l < this.local.length; l++) {
                let a = this.local[l];
                if (a.from < s && a.to > i && a.type instanceof jt) {
        ...
        localsInner(e) {
            if (this == me) return pn;
            if (e.inlineContent || !this.local.some(jt.is)) return this.local;
            let n = [];
            for (let r = 0; r < this.local.length; r++)
                this.local[r].type instanceof jt || n.push(this.local[r]);
            return n;
        }
        forEachSet(e) {
            e(this);
...
var me = J.empty,
    Wr = class t {
        ...
        map(e, n) {
            let r = this.members.map((o) => o.map(e, n, Kt));
            return t.from(r);
        }
        forChild(e, n) {
        ...
        static from(e) {
            switch (e.length) {
                ...
                default:
                    return new t(
                        e.every((n) => n instanceof J)
                            ? e
                            : e.reduce(
                                  (n, r) =>
                                      n.concat(r instanceof J ? r : r.members),
                                  [],
                              ),
                    );
            }
...
function zm(t, e, n, r, o, i, s) {
    ...
    for (let c = 0; c < l.length; c += 3)
        if (l[c + 1] < 0) {
            ...
            let f = n.map(t[c + 1] + i, -1),
                h = f - o,
                { index: p, offset: m } = r.content.findIndex(d),
                g = r.maybeChild(p);
            if (g && m == d && m + g.nodeSize == h) {
                let y = l[c + 2].mapInner(n, g, u + 1, t[c] + i + 1, s);
                y != me
                    ? ((l[c] = d), (l[c + 1] = h), (l[c + 2] = y))
                    : ((l[c + 1] = -2), (a = !0));
            } else a = !0;
        }
    if (a) {
        let c = Hm(l, t, e, n, o, i, s),
            u = _r(c, r, 0, s);
        e = u.local;
...
function Qc(t, e) {
    ...
    for (let r = 0; r < t.length; r++) {
        let o = t[r];
        n.push(new Y(o.from + e, o.to + e, o.type));
    }
    return n;
}
function Hm(t, e, n, r, o, i, s) {
    function l(a, c) {
...
function _r(t, e, n, r) {
    ...
    e.forEach((l, a) => {
        ...
        if (c) {
            i = !0;
            let u = _r(c, l, n + a + 1, r);
            u != me && o.push(a, a + l.nodeSize, u);
        }
    });
    let s = Qc(i ? eu(t) : t, -n).sort(Ut);
    for (let l = 0; l < s.length; l++)
        s[l].type.valid(e, s[l]) ||
            (r.onRemove && r.onRemove(s[l].spec), s.splice(l--, 1));
    return s.length || o.length ? new J(s, o) : me;
}
function Ut(t, e) {
            ...
            for (let o = n + 1; o < e.length; o++) {
                ...
                if (i.from == r.from) {
                    i.to != r.to &&
                        ...
                        pc(e, o + 1, i.copy(r.to, i.to)));
                    continue;
                } else {
                    i.from < r.to &&
                        (e == t && (e = t.slice()),
                        (e[n] = r.copy(r.from, i.from)),
                        pc(e, o, r.copy(i.from, r.to)));
                    break;
                }
            }
    }
...
function $i(t) {
    ...
    return (
        ...
        t.cursorWrapper &&
            e.push(J.create(t.state.doc, [t.cursorWrapper.deco])),
        Wr.from(e)
    );
}
var Fm = {
    ...
    ss = class {
        ...
        start() {
            this.observer &&
                ...
                this.observer.observe(this.view.dom, Fm)),
                this.onCharData &&
        ...
        onSelectionChange() {
            if (sc(this.view)) {
                ...
                if (ke && Tt <= 11 && !this.view.state.selection.empty) {
        ...
        ignoreSelectionChange(e) {
            ...
            let n = new Set(),
                r;
            for (let i = e.focusNode; i; i = gn(i)) n.add(i);
        ...
        flush() {
            ...
            jr(r) &&
            (c = as(e)) &&
            c.eq(E.near(e.state.doc.resolve(0), 1))
                ? ((e.input.lastFocus = 0),
                  ft(e),
                  this.currentSelection.set(r),
                  e.scrollToSelection())
                : (i > -1 || o) &&
                  (i > -1 && (e.docView.markDirty(i, s), Vm(e)),
        ...
        registerMutation(e, n) {
            ...
            if (e.type == "childList") {
                ...
                let o = e.previousSibling,
                    i = e.nextSibling;
                if (ke && Tt <= 11 && e.addedNodes.length)
                    for (let u = 0; u < e.addedNodes.length; u++) {
                        let { previousSibling: d, nextSibling: f } =
                            e.addedNodes[u];
                        (!d ||
                            Array.prototype.indexOf.call(e.addedNodes, d) <
                                0) &&
                            (o = d),
                            (!f ||
                ...
                let s = o && o.parentNode == e.target ? ue(o) + 1 : 0,
...
function Vm(t) {
    if (
        ...
        if (((t.requiresGeckoHackNode = Ve), gc)) return;
        console.warn(
...
function jm(t, e, n) {
    ...
    let d = t.state.doc,
        f = t.someProp("domParser") || Ue.fromSchema(t.state.schema),
        h = d.resolve(s),
        p = null,
        m = f.parse(r, {
            topNode: h.parent,
...
function Km(t) {
    ...
    if (t.nodeName == "BR" && t.parentNode) {
        if (xe && /^(ul|ol)$/i.test(t.parentNode.nodeName)) {
            let n = document.createElement("div");
            return n.appendChild(document.createElement("li")), { skip: n };
        } else if (
            t.parentNode.lastChild == t ||
            (xe && /^(tr|table)$/i.test(t.parentNode.nodeName))
        )
            return { ignore: !0 };
...
function Jm(t, e, n, r, o) {
    ...
    if (((t.input.compositionPendingChanges = 0), e < 0)) {
        ...
        if (B && !t.state.selection.eq(B)) {
            if (
                ...
                t.someProp("handleKeyDown", (_) => _(t, Vt(13, "Enter")))
            )
                return;
            let D = t.state.tr.setSelection(B);
            v == "pointer"
                ? D.setMeta("pointer", !0)
                : v == "key" && D.scrollIntoView(),
    ...
    let p = Ym(d.content, c.doc.content, c.from, f, h);
    if (
        (p && t.input.domChangeCount++,
        ((yn && t.input.lastIOSEnter > Date.now() - 225) || dt) &&
            o.some((v) => v.nodeType == 1 && !Um.test(v.nodeName)) &&
            (!p || p.endA >= p.endB) &&
            t.someProp("handleKeyDown", (v) => v(t, Vt(13, "Enter"))))
    ) {
        t.input.lastIOSEnter = 0;
        return;
    }
    if (!p)
        if (
            ...
            if (c.sel) {
                let v = bc(t, t.state.doc, c.sel);
                if (v && !v.eq(t.state.selection)) {
                    let B = t.state.tr.setSelection(v);
                    i && B.setMeta("composition", i), t.dispatch(B);
                }
            }
            return;
        }
    t.state.selection.from < t.state.selection.to &&
        p.start == p.endB &&
        t.state.selection instanceof A &&
    ...
    if (
        ...
        Gm(u, p.start, p.endA, m, g) &&
        t.someProp("handleKeyDown", (v) => v(t, Vt(8, "Backspace")))
    ) {
        dt && ge && t.domObserver.suppressSelectionUpdates();
        return;
    }
                ...
                D &&
                    !(
                        (ge &&
                            ...
                            (D.head == C || D.head == B.mapping.map(S) - 1)) ||
                        (ke && D.empty && D.head == C)
                    ) &&
                    B.setSelection(D);
            }
    ...
    if (b) {
        if (m.pos == g.pos) {
            ke &&
                ...
                setTimeout(() => ft(t), 20));
            let v = R(t.state.tr.delete(C, S)),
                B = u.resolve(p.start).marksAcross(u.resolve(p.endA));
            B && v.ensureMarks(B), t.dispatch(v);
        } else if (
            p.endA == p.endB &&
            (P = qm(
            ...
            let v = R(t.state.tr);
            P.type == "add"
                ? v.addMark(C, S, P.mark)
                : v.removeMark(C, S, P.mark),
                t.dispatch(v);
        } else if (
            ...
            let v = m.parent.textBetween(m.parentOffset, g.parentOffset),
                B = () => R(t.state.tr.insertText(v, C, S));
            t.someProp("handleTextInput", (D) => D(t, C, S, v, B)) ||
                t.dispatch(B());
        }
    } else t.dispatch(R());
}
function bc(t, e, n) {
    return Math.max(n.anchor, n.head) > e.content.size
        ? null
        : cs(t, e.resolve(n.anchor), e.resolve(n.head));
}
function qm(t, e) {
    ...
    if (w.from(c).eq(t)) return { mark: l, type: s };
}
function Gm(t, e, n, r, o) {
    if (n - e <= o.pos - r.pos || Vi(r, !0, !1) < o.pos) return !1;
    let i = t.resolve(e);
    ...
    if (i.parentOffset < i.parent.content.size || !i.parent.isTextblock)
        return !1;
    let s = t.resolve(Vi(i, !0, !0));
    return !s.parent.isTextblock || s.pos > n || Vi(s, !0, !1) < n
        ? !1
...
var Jn = class {
    constructor(e, n) {
        (this._root = null),
            ...
            (this.editable = kc(this)),
            Sc(this),
            (this.nodeViews = Cc(this)),
            (this.docView = ec(
                this.state.doc,
                wc(this),
                $i(this),
            ...
            (this.domObserver = new ss(this, (r, o, i, s) =>
                Jm(this, r, o, i, s),
            )),
    ...
    update(e) {
        ...
        (this._props = e),
            e.plugins &&
                (e.plugins.forEach(Mc), (this.directPlugins = e.plugins)),
    ...
    updateStateInner(e, n) {
        ...
        let o = this.state,
            i = !1,
            s = !1;
        e.storedMarks && this.composing && (Gc(this), (s = !0)),
            (this.state = e);
        ...
        if (
            ...
            let h = Cc(this);
            Qm(h, this.nodeViews) && ((this.nodeViews = h), (i = !0));
        }
        (l || n.handleDOMEvents != this._props.handleDOMEvents) && ts(this),
            (this.editable = kc(this)),
            Sc(this);
        let a = $i(this),
            c = wc(this),
        ...
        if (s) {
            ...
            !(
                ...
                ? ft(this, h)
                : (zc(this, e.selection), this.domObserver.setCurSelection()),
                this.domObserver.start();
        }
    ...
    updateDraggedNode(e, n) {
        ...
        this.dragging = new $r(
            e.slice,
            e.move,
            o < 0 ? void 0 : O.create(this.state.doc, o),
        );
    }
    someProp(e, n) {
    ...
    endOfTextblock(e, n) {
        return Gp(this, n || this.state, e);
    }
    pasteHTML(e, n) {
        return Kn(this, "", e, !1, n || new ClipboardEvent("paste"));
    }
    pasteText(e, n) {
        return Kn(this, e, null, !0, n || new ClipboardEvent("paste"));
    }
    ...
    destroy() {
        this.docView &&
            ...
            this.destroyPluginViews(),
            this.mounted
                ? (this.docView.update(this.state.doc, [], $i(this), this),
...
Jn.prototype.dispatch = function (t) {
...
function wc(t) {
    ...
    return (
        ...
        [Y.node(0, t.state.doc.content.size, e)]
    );
}
function Sc(t) {
    if (t.markCursor) {
        ...
        (e.className = "ProseMirror-separator"),
            ...
            (t.cursorWrapper = {
                dom: e,
                deco: Y.widget(t.state.selection.from, e, {
                    raw: !0,
                    marks: t.markCursor,
                }),
            });
...
var ht = {
    ...
    Zm = typeof navigator < "u" && /Mac/.test(navigator.platform),
    eg =
        typeof navigator < "u" &&
        /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(
            navigator.userAgent,
        );
for (re = 0; re < 10; re++) ht[48 + re] = ht[96 + re] = String(re);
var re;
for (re = 1; re <= 24; re++) ht[re + 111] = "F" + re;
var re;
for (re = 65; re <= 90; re++)
    (ht[re] = String.fromCharCode(re + 32)), (Jr[re] = String.fromCharCode(re));
var re;
for (Ur in ht) Jr.hasOwnProperty(Ur) || (Jr[Ur] = ht[Ur]);
var Ur;
function tu(t) {
    var e =
            (Zm && t.metaKey && t.shiftKey && !t.ctrlKey && !t.altKey) ||
            (eg && t.shiftKey && t.key && t.key.length == 1) ||
            t.key == "Unidentified",
        n =
            (!e && t.key) ||
            (t.shiftKey ? Jr : ht)[t.keyCode] ||
            t.key ||
            "Unidentified";
    return (
        n == "Esc" && (n = "Escape"),
...
var tg =
    ...
    ng = typeof navigator < "u" && /Win/.test(navigator.platform);
function rg(t) {
    let e = t.split(/-(?!$)/),
        n = e[e.length - 1];
    n == "Space" && (n = " ");
    ...
    for (let l = 0; l < e.length - 1; l++) {
        ...
        else if (/^mod$/i.test(a)) tg ? (s = !0) : (o = !0);
...
function nu(t) {
    return new N({ props: { handleKeyDown: Yn(t) } });
}
function Yn(t) {
    let e = og(t);
    return function (n, r) {
...
var ys = (t, e, n) => {
        ...
        let i = o.nodeBefore;
        if (hu(t, o, e, -1)) return !0;
        if (r.parent.content.size == 0 && (xn(i, "end") || O.isSelectable(i)))
            for (let s = r.depth; ; s--) {
                let l = Fn(t.doc, r.before(s), r.after(s), M.empty);
                    ...
                    if (e) {
                        ...
                        a.setSelection(
                            xn(i, "end")
                                ...
                                : O.create(a.doc, o.pos - i.nodeSize),
                        ),
                            e(a.scrollIntoView());
                    }
                    return !0;
...
var bs = (t, e, n) => {
    ...
    return !s || !O.isSelectable(s)
        ? !1
        : (e &&
              e(
                  t.tr
                      .setSelection(O.create(t.doc, i.pos - s.nodeSize))
                      .scrollIntoView(),
              ),
          !0);
};
...
var ws = (t, e, n) => {
        ...
        if (
            ...
            (xn(i, "start") || O.isSelectable(i))
        ) {
            let s = Fn(t.doc, r.before(), r.after(), M.empty);
            if (s && s.slice.size < s.to - s.from) {
                if (e) {
                    let l = t.tr.step(s);
                    l.setSelection(
                        xn(i, "start")
                            ? E.findFrom(l.doc.resolve(l.mapping.map(o.pos)), 1)
                            : O.create(l.doc, l.mapping.map(o.pos)),
                    ),
                        e(l.scrollIntoView());
                }
                return !0;
    ...
    Ss = (t, e, n) => {
        ...
        return !s || !O.isSelectable(s)
            ? !1
            : (e &&
                  e(t.tr.setSelection(O.create(t.doc, i.pos)).scrollIntoView()),
              !0);
    };
function ks(t) {
    if (!t.parent.type.spec.isolating)
...
var cu = (t, e) => {
        let n = t.selection,
            ...
            o;
        if (r) {
            if (n.node.isTextblock || !Ne(t.doc, n.from)) return !1;
            o = n.from;
        ...
        if (e) {
            ...
            r &&
                i.setSelection(
                    O.create(i.doc, o - t.doc.resolve(o).nodeBefore.nodeSize),
                ),
                e(i.scrollIntoView());
        }
        return !0;
    ...
    uu = (t, e) => {
        let n = t.selection,
            r;
        if (n instanceof O) {
            if (n.node.isTextblock || !Ne(t.doc, n.to)) return !1;
            r = n.to;
...
function ig(t) {
    return (e, n) => {
        ...
        for (let h = r.depth; ; h--)
            if (r.node(h).isBlock) {
                (a = r.end(h) == r.pos + (r.depth - h)),
                    ...
                    (l = Ms(r.node(h - 1).contentMatchAt(r.indexAfter(h - 1))));
        ...
        let u = e.tr;
        (e.selection instanceof A || e.selection instanceof be) &&
            u.deleteSelection();
        let d = u.mapping.map(r.pos),
            f = Ae(u.doc, d, i.length, i);
        if (
            (f ||
                ((i[0] = l ? { type: l } : null),
                (f = Ae(u.doc, d, i.length, i))),
        ...
        if ((u.split(d, i.length, i), !a && c && r.node(s).type != l)) {
            let h = u.mapping.map(r.before(s)),
                p = u.doc.resolve(h);
            l &&
                r.node(s - 1).canReplaceWith(p.index(), p.index() + 1, l) &&
                u.setNodeMarkup(u.mapping.map(r.before(s)), l);
        }
...
var fu = (t, e) => {
        ...
        return i == 0
            ? !1
            : ((o = n.before(i)),
              e && e(t.tr.setSelection(O.create(t.doc, o))),
              !0);
    },
    lg = (t, e) => (e && e(t.tr.setSelection(new be(t.doc))), !0);
function ag(t, e, n) {
    let r = e.nodeBefore,
        o = e.nodeAfter,
        i = e.index();
...
function hu(t, e, n, r) {
    ...
    let u = i.type.spec.isolating || (r > 0 && a) ? null : E.findFrom(e, 1),
        d = u && u.$from.blockRange(u.$to),
        f = d && at(d);
    if (f != null && f >= e.depth)
        return n && n(t.tr.lift(d, f).scrollIntoView()), !0;
    if (c && xn(i, "start", !0) && xn(o, "end")) {
        let h = o,
            p = [];
    ...
    return function (e, n) {
        ...
        return o.node(i).isTextblock
            ? (n &&
                  n(
                      e.tr.setSelection(
                          A.create(e.doc, t < 0 ? o.start(i) : o.end(i)),
                      ),
                  ),
              !0)
            : !1;
...
function gu(t, e = null) {
    return function (n, r) {
        ...
        if (!s) return !1;
        let l = r ? n.tr : null;
        return ug(l, s, t, e) ? (r && r(l.scrollIntoView()), !0) : !1;
    };
}
function ug(t, e, n, r = null) {
    let o = !1,
        i = e,
        s = e.$from.doc;
    if (
        ...
        (i = new zt(a, a, e.depth)),
            e.endIndex < e.parent.childCount &&
                (e = new zt(e.$from, s.resolve(e.$to.end(e.depth)), e.depth)),
            (o = !0);
    }
    let l = cn(i, n, r, e);
    return l ? (t && dg(t, e, l, o, n), !0) : !1;
}
    ...
    i < s &&
        (o.step(
            new ne(
                ...
                i,
                s,
                new M(w.from(n.create(null, r.parent.copy())), 1, 0),
                1,
                !0,
            ),
        ),
        (r = new zt(o.doc.resolve(r.$from.pos), o.doc.resolve(s), r.depth)));
    let l = at(r);
    if (l == null) return !1;
    o.lift(r, l);
...
function hg(t, e, n) {
    ...
    if (
        !c.canReplace(
            u + (l ? 0 : 1),
            u + 1,
            s.content.append(a ? w.empty : w.from(o)),
        )
    )
        return !1;
    let d = i.pos,
    ...
    return (
        r.step(
            new ne(
                ...
                f - 1,
                new M(
                    (l ? w.empty : w.from(o.copy(w.empty))).append(
                        a ? w.empty : w.from(o.copy(w.empty)),
                    ),
                    l ? 0 : 1,
                    a ? 0 : 1,
                ),
    ...
    return function (e, n) {
        ...
        if (n) {
            let c = a.lastChild && a.lastChild.type == l.type,
                u = w.from(c ? t.create() : null),
                d = new M(
                    w.from(t.create(null, w.from(l.type.create(null, u)))),
                    c ? 3 : 1,
                    0,
                ),
                f = i.start,
            ...
            n(
                e.tr
                    .step(new ne(f - (c ? 3 : 1), h, f, h, d, 1, !0))
                    .scrollIntoView(),
            );
        }
        return !0;
...
var pg = Object.defineProperty,
    Tu = (t, e) => {
        for (var n in e) pg(t, n, { get: e[n], enumerable: !0 });
    };
function no(t) {
        ...
        buildProps(t, e = !0) {
            let { rawCommands: n, editor: r, state: o } = this,
                ...
                s = {
                    ...
                    editor: r,
                    view: i,
                    state: no({ state: o, transaction: t }),
                    dispatch: e ? () => {} : void 0,
...
function Xn(t, e, n) {
    if (t instanceof le || t instanceof w) return t;
    ...
    if (r)
        try {
            if (Array.isArray(t) && t.length > 0)
                return w.fromArray(t.map((l) => e.nodeFromJSON(l)));
    ...
    if (o) {
        if (n.errorOnInvalidContent) {
            ...
            if (
                (n.slice
                    ? Ue.fromSchema(a).parseSlice(Gr(t), n.parseOptions)
                    : Ue.fromSchema(a).parse(Gr(t), n.parseOptions),
        ...
        let i = Ue.fromSchema(e);
        return n.slice
            ? i.parseSlice(Gr(t), n.parseOptions).content
            : i.parse(Gr(t), n.parseOptions);
    }
    return Xn("", e, n);
}
function Ls(t, e, n = {}, r = {}) {
...
function I(t, e, n) {
    return t.config[e] === void 0 && t.parent
        ...
        : typeof t.config[e] == "function"
          ? t.config[e].bind({
                ...n,
                parent: t.parent ? I(t.parent, e, n) : null,
            })
          : t.config[e];
}
function Fs(t) {
    return t
        .map((e) => {
            let n = { name: e.name, options: e.options, storage: e.storage },
                r = I(e, "addExtensions", n);
            return r ? [e, ...Fs(r())] : e;
        })
        .flat(10);
}
function $s(t, e) {
    let n = it.fromSchema(e).serializeFragment(t),
...
function W(t, e = void 0, ...n) {
    return Ou(t) ? (e ? t.bind(e)(...n) : t(...n)) : t;
}
function gg(t = {}) {
...
function Nu(t) {
    let e = [],
        { nodeExtensions: n, markExtensions: r } = Qn(t),
        o = [...n, ...r],
        i = {
            default: null,
            validate: void 0,
    ...
    return (
        t.forEach((s) => {
            let l = {
                ...
                a = I(s, "addGlobalAttributes", l);
            if (!a) return;
            a().forEach((u) => {
                u.types.forEach((d) => {
                    Object.entries(u.attributes).forEach(([f, h]) => {
                        e.push({ type: d, name: f, attribute: { ...i, ...h } });
                    });
                });
            });
        }),
        o.forEach((s) => {
            ...
            Object.entries(c).forEach(([u, d]) => {
                ...
                typeof f?.default == "function" && (f.default = f.default()),
                    ...
                    e.push({ type: s.name, name: u, attribute: f });
            });
        }),
        e
    );
...
function bg(t, e) {
    var n;
    let r = Nu(t),
        { nodeExtensions: o, markExtensions: i } = Qn(t),
        s = (n = o.find((c) => I(c, "topNode"))) == null ? void 0 : n.name,
        l = Object.fromEntries(
            o.map((c) => {
                let u = r.filter((y) => y.type === c.name),
                    d = {
                        name: c.name,
                        options: c.options,
                        storage: c.storage,
                    ...
                    f = t.reduce((y, b) => {
                        let x = I(b, "extendNodeSchema", d);
                        return { ...y, ...(x ? x(c) : {}) };
                    }, {}),
                    h = wu({
                        ...f,
                        content: W(I(c, "content", d)),
                        marks: W(I(c, "marks", d)),
                        group: W(I(c, "group", d)),
                        inline: W(I(c, "inline", d)),
                        atom: W(I(c, "atom", d)),
                        selectable: W(I(c, "selectable", d)),
                        draggable: W(I(c, "draggable", d)),
                        code: W(I(c, "code", d)),
                        whitespace: W(I(c, "whitespace", d)),
                        linebreakReplacement: W(
                            I(c, "linebreakReplacement", d),
                        ),
                        defining: W(I(c, "defining", d)),
                        isolating: W(I(c, "isolating", d)),
                    ...
                    p = W(I(c, "parseHTML", d));
                p && (h.parseDOM = p.map((y) => xu(y, u)));
                let m = I(c, "renderHTML", d);
                m &&
                    (h.toDOM = (y) => m({ node: y, HTMLAttributes: eo(y, u) }));
                let g = I(c, "renderText", d);
                return g && (h.toText = g), [c.name, h];
            }),
        ),
        a = Object.fromEntries(
            i.map((c) => {
                let u = r.filter((g) => g.type === c.name),
                    d = {
                        name: c.name,
                        options: c.options,
                        storage: c.storage,
                    ...
                    f = t.reduce((g, y) => {
                        let b = I(y, "extendMarkSchema", d);
                        return { ...g, ...(b ? b(c) : {}) };
                    }, {}),
                    h = wu({
                        ...f,
                        inclusive: W(I(c, "inclusive", d)),
                        excludes: W(I(c, "excludes", d)),
                        group: W(I(c, "group", d)),
                        spanning: W(I(c, "spanning", d)),
                        code: W(I(c, "code", d)),
                        attrs: Object.fromEntries(
                            u.map((g) => {
                                var y, b;
                    ...
                    p = W(I(c, "parseHTML", d));
                p && (h.parseDOM = p.map((g) => xu(g, u)));
                let m = I(c, "renderHTML", d);
                return (
                    m &&
                        (h.toDOM = (g) =>
                            m({ mark: g, HTMLAttributes: eo(g, u) })),
                    [c.name, h]
                );
            }),
        );
    return new sn({ topNode: s, nodes: l, marks: a });
}
function xg(t) {
...
function Ws(t, e) {
    let n = oo(typeof e == "string" ? e : e.name, t.schema);
    return n === "node" ? Sg(t, e) : n === "mark" ? Iu(t, e) : {};
}
function kg(t, e = JSON.stringify) {
    let n = {};
    return t.filter((r) => {
        let o = e(r);
...
function Ks(t, e, n) {
    ...
    if (
        ((!o.node || !o.node.marks.some((u) => u.type === e)) &&
            (o = t.parent.childBefore(t.parentOffset)),
        !o.node ||
            !o.node.marks.some((u) => u.type === e) ||
    ...
    let s = o.index,
        ...
        a = s + 1,
        c = l + o.node.nodeSize;
    for (; s > 0 && Su([...t.parent.child(s - 1).marks], e, n); )
        (s -= 1), (l -= t.parent.child(s).nodeSize);
    for (; a < t.parent.childCount && Su([...t.parent.child(a).marks], e, n); )
...
function Bs(t, e, n = {}) {
    ...
    if (
        (o.forEach(({ $from: d, $to: f }) => {
            ...
            t.doc.nodesBetween(h, p, (m, g) => {
                ...
                let y = Math.max(h, g),
                    b = Math.min(p, g + m.nodeSize),
                    x = b - y;
                (s += x),
                    l.push(
                        ...m.marks.map((C) => ({ mark: C, from: y, to: b })),
                    );
            });
        }),
        s === 0)
    ...
    let a = l
            ...
            .filter((d) => to(d.mark.attrs, n, { strict: !1 }))
...
function Ge(t, e, n = {}) {
    let { from: r, to: o, empty: i } = t.selection,
        s = e ? Q(e, t.schema) : null,
        l = [];
    t.doc.nodesBetween(r, o, (d, f) => {
        if (d.isText) return;
        let h = Math.max(r, f),
            p = Math.min(o, f + d.nodeSize);
        l.push({ node: d, from: h, to: p });
    });
    let a = o - r,
        c = l
            .filter((d) => (s ? s.name === d.node.type.name : !0))
            .filter((d) => to(d.node.attrs, n, { strict: !1 }));
    return i ? !!c.length : c.reduce((d, f) => d + f.to - f.from, 0) >= a;
}
function Us(t, e, n = {}) {
    if (!e) return Ge(t, null, n) || Bs(t, null, n);
    let r = oo(e, t.schema);
    return r === "node" ? Ge(t, e, n) : r === "mark" ? Bs(t, e, n) : !1;
}
var zu = (t, e) => {
        let { $from: n, $to: r, $anchor: o } = t.selection;
        if (e) {
            let i = Ye((l) => l.type.name === e)(t.selection);
            if (!i) return !1;
...
function er(t, { checkChildren: e = !0, ignoreWhitespace: n = !1 } = {}) {
    var r;
    if (n) {
    ...
    if (e) {
        ...
        return (
            t.content.forEach((i) => {
                o !== !1 &&
                    (er(i, { ignoreWhitespace: n, checkChildren: e }) ||
                        (o = !1));
            }),
            o
        );
...
function $u(t, e = null) {
    ...
    let o = n.from,
        i = r.to;
    return e === "all"
        ? A.create(t, pt(0, o, i), pt(t.content.size, o, i))
        : A.create(t, pt(e, o, i), pt(e, o, i));
}
function vg(t, e, n) {
    let r = t.steps.length - 1;
    if (r < e) return;
...
function Yr(t) {
    ...
    return (
        s.forEach((f) => {
            ...
            if (!h) return;
            let p = a.state.tr,
                m = no({ state: a.state, transaction: p }),
                g = { from: r - (h[0].length - i.length), to: o },
                {
                    commands: y,
                    chain: b,
                    can: x,
                } = new ro({ editor: n, state: m });
            f.handler({
                state: m,
                range: g,
                match: h,
        ...
        r = new N({
            state: {
                ...
                apply(o, i, s) {
                    let l = o.getMeta(r);
                    if (l) return l;
                    let a = o.getMeta("applyInputRules");
                    return (
                        !!a &&
                            setTimeout(() => {
                                let { text: u } = a;
    ...
    return (
        Xr(t) &&
            ...
            Object.keys(e).forEach((r) => {
                Xr(e[r]) && Xr(t[r]) ? (n[r] = Vu(t[r], e[r])) : (n[r] = e[r]);
            }),
        n
    );
}
var Js = class {
        ...
        get options() {
            return { ...(W(I(this, "addOptions", { name: this.name })) || {}) };
        }
        get storage() {
            return {
                ...(W(
        ...
        configure(t = {}) {
            let e = this.extend({
                ...this.config,
                addOptions: () => Vu(this.options, t),
            });
            return (e.name = this.name), (e.parent = this.parent), e;
        }
        extend(t = {}) {
            let e = new this.constructor({ ...this.config, ...t });
            return (
                (e.parent = this),
                (this.child = e),
...
function Dg(t) {
    let {
        ...
        { commands: a, chain: c, can: u } = new ro({ editor: e, state: n }),
        d = [];
    return (
        n.doc.nodesBetween(r, o, (h, p) => {
            if (!h.isTextblock || h.type.spec.code) return;
            let m = Math.max(r, p),
                g = Math.min(o, p + h.content.size),
                y = h.textBetween(m - p, g - p, void 0, "\uFFFC");
            Rg(y, i.find, s).forEach((x) => {
                if (x.index === void 0) return;
                let C = m + x.index + 1,
                    S = C + x[0].length,
                    R = { from: n.tr.mapping.map(C), to: n.tr.mapping.map(S) },
                    P = i.handler({
                        state: n,
                        range: R,
                        match: x,
        ...
        (u) =>
            new N({
                ...
                appendTransaction: (d, f, h) => {
                    ...
                    let x = f.doc.content.findDiffStart(h.doc.content),
                        C = f.doc.content.findDiffEnd(h.doc.content);
                    if (!(!Og(x) || !C || x === C.b))
                        return a({
                            rule: u,
                            state: h,
...
var co = class {
    constructor(t, e) {
        (this.splittableMarks = []),
            (this.editor = e),
            (this.extensions = Ru(t)),
            (this.schema = bg(this.extensions, e)),
            ...
            o = e
                .map((i) => {
                    let s = {
                            ...
                            editor: t,
                            type: Ds(i.name, this.schema),
                        },
                        l = [],
                        a = I(i, "addKeyboardShortcuts", s),
                        c = {};
                    if (
                        (i.type === "mark" &&
                            I(i, "exitable", s) &&
                            (c.ArrowRight = () =>
                                te.handleExit({ editor: t, mark: i })),
                        a)
                    ) {
                        let p = Object.fromEntries(
                            Object.entries(a()).map(([m, g]) => [
                                m,
                                () => g({ editor: t }),
                            ]),
                        );
                    ...
                    let u = nu(c);
                    l.push(u);
                    let d = I(i, "addInputRules", s);
                    ku(i, t.options.enableInputRules) && d && n.push(...d());
                    let f = I(i, "addPasteRules", s);
                    ku(i, t.options.enablePasteRules) && f && r.push(...f());
                    let h = I(i, "addProseMirrorPlugins", s);
                    if (h) {
                        let p = h();
                        l.push(...p);
                    }
    ...
    get attributes() {
        return Nu(this.extensions);
    }
    get nodeViews() {
        let { editor: t } = this,
            { nodeExtensions: e } = Qn(this.extensions);
        return Object.fromEntries(
            e
                .filter((n) => !!I(n, "addNodeView"))
                .map((n) => {
    ...
    get markViews() {
        let { editor: t } = this,
            { markExtensions: e } = Qn(this.extensions);
        return Object.fromEntries(
            e
                .filter((n) => !!I(n, "addMarkView"))
                .map((n) => {
                    let r = this.attributes.filter((l) => l.type === n.name),
                        o = {
                            name: n.name,
    ...
    setupExtensions() {
        ...
        (this.editor.extensionStorage = Object.fromEntries(
            ...
            t.forEach((e) => {
                ...
                e.type === "mark" &&
                    ((n = W(I(e, "keepOnSplit", r))) == null || n) &&
                    this.splittableMarks.push(e.name);
                let o = I(e, "onBeforeCreate", r),
                    i = I(e, "onCreate", r),
                    s = I(e, "onUpdate", r),
                    l = I(e, "onSelectionUpdate", r),
                    a = I(e, "onTransaction", r),
                    c = I(e, "onFocus", r),
                    u = I(e, "onBlur", r),
                    d = I(e, "onDestroy", r);
...
Tu(Lg, {
    ...
    Paste: () => ed,
    Tabindex: () => td,
    focusEventsPluginKey: () => Xu,
});
var $ = class _u extends Js {
        constructor() {
    ...
    ju = $.create({
        ...
        addProseMirrorPlugins() {
            return [
                new N({
                    key: new L("clipboardTextSerializer"),
                    props: {
...
Tu(Ku, {
    ...
    clearNodes: () => Hg,
    command: () => Fg,
    createParagraphNear: () => $g,
    cut: () => Vg,
    deleteCurrentNode: () => Wg,
    deleteNode: () => _g,
    deleteRange: () => jg,
    deleteSelection: () => Kg,
    enter: () => Ug,
    ...
    Vg =
        ...
        ({ editor: n, tr: r }) => {
            ...
            return (
                ...
                r.setSelection(new A(r.doc.resolve(Math.max(s - 1, 0)))),
                !0
            );
        },
    Wg =
...
var Xg =
        ...
        ({ editor: n, view: r, tr: o, dispatch: i }) => {
            ...
            let l = $u(o.doc, t) || n.state.selection,
    ...
    Qg = (t, e) => (n) => t.every((r, o) => e(r, { ...n, index: o })),
    Zg =
        (t, e) =>
        ({ tr: n, commands: r }) =>
            r.insertContentAt(
        ...
        ({ tr: r, dispatch: o, editor: i }) => {
            ...
            if (o) {
                ...
                let l,
                    ...
                    u = { preserveWhitespace: "full", ...n.parseOptions };
                if (
                ...
                if (h) {
                    ...
                    g = l;
                    let y = a.$from.parentOffset === 0,
                        b = a.$from.node().isText || a.$from.node().isTextblock,
                        x = a.$from.node().content.size > 0;
                    y && b && x && (d = Math.max(0, d - 1)),
                        r.replaceWith(d, f, g);
                }
                n.updateSelection && vg(r, r.steps.length - 1, -1),
                    n.applyInputRules &&
                        r.setMeta("applyInputRules", { from: d, text: g }),
                    n.applyPasteRules &&
                        r.setMeta("applyPasteRules", { from: d, text: g });
            }
            return !0;
        },
    ny =
    ...
    sy =
        ...
        ({ state: t, dispatch: e, tr: n }) => {
            try {
                let r = Ft(t.doc, t.selection.$from.pos, -1);
...
function uy(t) {
    ...
    for (let l = 0; l < e.length - 1; l += 1) {
        ...
        else if (/^mod$/i.test(a)) qs() || Uu() ? (s = !0) : (o = !0);
        else throw new Error(`Unrecognized modifier name: ${a}`);
    }
    return (
        r && (n = `Alt-${n}`),
...
var dy =
        ...
        ({ editor: e, view: n, tr: r, dispatch: o }) => {
            let i = uy(t).split(/-(?!$)/),
                s = i.find(
                    (c) => !["Alt", "Ctrl", "Meta", "Shift"].includes(c),
                ),
...
var gy =
        ...
        ({ tr: n, state: r, dispatch: o }) => {
            let i = null,
                s = null,
                l = oo(typeof t == "string" ? t : t.name, r.schema);
            return l
                ? (l === "node" && (i = Q(t, r.schema)),
                  ...
                  o &&
                      n.selection.ranges.forEach((a) => {
                          r.doc.nodesBetween(a.$from.pos, a.$to.pos, (c, u) => {
                              i &&
                                  i === c.type &&
                                  n.setNodeMarkup(u, void 0, Mu(c.attrs, e)),
                                  s &&
                                      c.marks.length &&
                                      c.marks.forEach((d) => {
                                          s === d.type &&
    ...
    return s.some(({ $from: l, $to: a }) => {
        ...
        return (
            t.doc.nodesBetween(l.pos, a.pos, (u, d, f) => {
                if (c) return !1;
                if (u.isInline) {
                    let h = !f || f.type.allowsMarkType(n),
                        p =
                            !!n.isInSet(u.marks) ||
                            !u.marks.some((m) => m.type.excludes(n));
                    c = h && p;
                }
                return !c;
            }),
...
function vu(t, e) {
    ...
    if (n) {
        let r = n.filter((o) => e?.includes(o.type.name));
        t.tr.ensureMarks(r);
    }
}
var Dy =
        ...
        ({ tr: e, state: n, dispatch: r, editor: o }) => {
            let { selection: i, doc: s } = e,
                ...
                u = Zr(c, l.node().type.name, l.node().attrs);
            if (i instanceof O && i.node.isBlock)
                return !l.parentOffset || !Ae(s, l.pos)
                    ? !1
                    : (r &&
                          (t && vu(n, o.extensionManager.splittableMarks),
            ...
            let d = a.parentOffset === a.parent.content.size,
                f =
                    l.depth === 0
                        ? void 0
                        : Zn(l.node(-1).contentMatchAt(l.indexAfter(-1))),
                h = d && f ? [{ type: f, attrs: u }] : void 0,
                p = Ae(e.doc, e.mapping.map(l.pos), 1, h);
            if (
                (!h &&
                    !p &&
                    Ae(
    ...
    Py =
        ...
        ({ tr: n, state: r, dispatch: o, editor: i }) => {
            ...
            if (
                ...
                if (o) {
                    let y = w.empty,
                        b = a.index(-1) ? 1 : a.index(-2) ? 2 : 3;
                    for (let v = a.depth - b; v >= a.depth - 3; v -= 1)
                        y = w.from(a.node(v).copy(y));
                    let x =
                            a.indexAfter(-1) < a.node(-2).childCount
                                ...
                                : a.indexAfter(-2) < a.node(-3).childCount
                                  ...
                                  : 3,
                        C = {
                            ...Zr(f, a.node().type.name, a.node().attrs),
                            ...e,
                        },
                        S =
                            ((s = l.contentMatch.defaultType) == null
                                ? void 0
                                : s.createAndFill(C)) || void 0;
                    y = y.append(w.from(l.createAndFill(null, S) || void 0));
                    let R = a.before(a.depth - (b - 1));
                    n.replace(R, a.after(-x), new M(y, 4 - b, 0));
                    let P = -1;
                    n.doc.nodesBetween(R, n.doc.content.size, (v, B) => {
                        if (P > -1) return !1;
                        v.isTextblock && v.content.size === 0 && (P = B + 1);
                    }),
                        P > -1 && n.setSelection(A.near(n.doc.resolve(P))),
                        n.scrollIntoView();
                }
                return !0;
            }
            let h = c.pos === a.end() ? d.contentMatchAt(0).defaultType : null,
                p = { ...Zr(f, d.type.name, d.attrs), ...e },
                m = { ...Zr(f, a.node().type.name, a.node().attrs), ...e };
            ...
            if (o) {
                let { selection: y, storedMarks: b } = r,
                    { splittableMarks: x } = i.extensionManager,
                    C = b || (y.$to.parentOffset && y.$from.marks());
                if ((n.split(a.pos, 2, g).scrollIntoView(), !C || !o))
                    return !0;
                let S = C.filter((R) => x.includes(R.type.name));
                n.ensureMarks(S);
            }
            return !0;
        },
    Ps = (t, e) => {
        let n = Ye((s) => s.type === e)(t.selection);
        if (!n) return !0;
        let r = t.doc.resolve(Math.max(0, n.pos - 1)).before(n.depth);
        if (r === void 0) return !0;
        let o = t.doc.nodeAt(r);
        return n.node.type === o?.type && Ne(t.doc, n.pos) && t.join(n.pos), !0;
    },
    Is = (t, e) => {
        let n = Ye((s) => s.type === e)(t.selection);
        if (!n) return !0;
        ...
        if (r === void 0) return !0;
        let o = t.doc.nodeAt(r);
        return n.node.type === o?.type && Ne(t.doc, r) && t.join(r), !0;
    },
    Iy =
        (t, e, n, r = {}) =>
        ({
            ...
            let { extensions: d, splittableMarks: f } = o.extensionManager,
                h = Q(t, s.schema),
                p = Q(e, s.schema),
                { selection: m, storedMarks: g } = s,
                { $from: y, $to: b } = m,
                x = y.blockRange(b),
                C = g || (m.$to.parentOffset && m.$from.marks());
            if (!x) return !1;
            let S = Ye((R) => Cu(R.type.name, d))(m);
            if (x.depth >= 1 && S && x.depth - S.depth <= 1) {
                if (S.node.type === h) return c.liftListItem(p);
                if (
                    Cu(S.node.type.name, d) &&
                    h.validContent(S.node.content) &&
                    l
                )
                    return a()
                        .command(() => (i.setNodeMarkup(S.pos, h), !0))
                        .command(() => Ps(i, h))
                        .command(() => Is(i, h))
                        .run();
            }
            return !n || !C || !l
                ? a()
                      .command(() =>
                          u().wrapInList(h, r) ? !0 : c.clearNodes(),
                      )
                      .wrapInList(h, r)
                      .command(() => Ps(i, h))
                      .command(() => Is(i, h))
                ...
                : a()
                      .command(() => {
                          let R = u().wrapInList(h, r),
                              P = C.filter((v) => f.includes(v.type.name));
                          return i.ensureMarks(P), R ? !0 : c.clearNodes();
                      })
                      .wrapInList(h, r)
                      .command(() => Ps(i, h))
                      .command(() => Is(i, h))
            ...
            for (let r = 0; r < n.length; r += 1) {
                ...
                if (o.spec.isInputRules && (i = o.getState(t))) {
                    if (e) {
                        ...
                        if (i.text) {
                            let a = s.doc.resolve(i.from).marks();
                            s.replaceWith(
                                i.from,
                                i.to,
                ...
                u.steps.forEach((h, p) => {
                    ...
                    if (h instanceof lt) {
                        let y = f.slice(p).map(h.from, -1),
                            b = f.slice(p).map(h.to),
                            x = f.invert().map(y, -1),
                            C = f.invert().map(b),
                            S =
                                (m = u.doc.nodeAt(y - 1)) == null
                                    ? void 0
                                    : m.marks.some((P) => P.eq(h.mark)),
                            R =
                                (g = u.doc.nodeAt(b)) == null
                                    ? void 0
                                    : g.marks.some((P) => P.eq(h.mark));
                        this.editor.emit("delete", {
                            type: "mark",
                            mark: h.mark,
                            from: h.from,
                            to: h.to,
                            deletedRange: { from: x, to: C },
        ...
        addKeyboardShortcuts() {
            let t = () =>
                    this.editor.commands.first(({ commands: s }) => [
                        ...
                        () =>
                            s.command(({ tr: l }) => {
                                let { selection: a, doc: c } = l,
                                    { empty: u, $anchor: d } = a,
                                    { pos: f, parent: h } = d,
                                    p =
                                        d.parent.isTextblock && f > 0
                                            ? l.doc.resolve(f - 1)
                                            : d,
                ...
                new N({
                    ...
                    appendTransaction: (t, e, n) => {
                        ...
                        let { empty: i, from: s, to: l } = e.selection,
                            ...
                            c = E.atEnd(e.doc).to;
                        if (i || !(s === a && l === c) || !er(n.doc)) return;
                        let f = n.tr,
                            h = no({ state: n, transaction: f }),
                            { commands: p } = new ro({
                                editor: this.editor,
                                state: h,
                            });
        ...
        get children() {
            ...
            return (
                this.node.content.forEach((n, r) => {
                    ...
                    let l = this.resolvedPos.doc.resolve(s);
                    if (!o && l.depth <= this.depth) return;
                    let a = new wn(l, this.editor, o, o ? n : null);
                    o && (a.actualDepth = this.depth + 1),
                        e.push(new wn(l, this.editor, o, o ? n : null));
                }),
                e
            );
        }
...
var nd = class extends mg {
    ...
    injectCSS() {
        this.options.injectCSS &&
            typeof document < "u" &&
            (this.css = Uy(Ky, this.options.injectNonce));
    }
    setOptions(t = {}) {
    ...
    unregisterPlugin(t) {
        ...
        let e = this.state.plugins,
            n = e;
        if (
            ([].concat(t).forEach((o) => {
                let i = typeof o == "string" ? `${o}$` : o.key;
    ...
    createExtensionManager() {
        ...
        this.extensionManager = new co(r, this);
    }
    createCommandManager() {
        this.commandManager = new ro({ editor: this });
    }
    createSchema() {
    ...
    dispatchTransaction(t) {
        ...
        if (this.isCapturingTransaction) {
            ...
            t.steps.forEach((c) => {
                var u;
                return (u = this.capturedTransaction) == null
                    ? void 0
                    : u.step(c);
            });
            return;
        }
        let { state: e, transactions: n } = this.state.applyTransaction(t),
        ...
        let s = n.findLast((c) => c.getMeta("focus") || c.getMeta("blur")),
            l = s?.getMeta("focus"),
            a = s?.getMeta("blur");
        l &&
            this.emit("focus", {
...
`,
        ...
        return wg(this.state.doc, {
            blockSeparator: e,
            textSerializers: { ...Pu(this.schema), ...n },
        });
    }
    get isEmpty() {
    ...
    $pos(t) {
        let e = this.state.doc.resolve(t);
        return new jy(e, this);
    }
    get $doc() {
        return this.$pos(0);
    }
...
function Ie(t) {
    return new ao({
        ...
        handler: ({ state: e, range: n, match: r }) => {
            let o = W(t.getAttributes, void 0, r);
...
function Xe(t) {
    return new ao({
        ...
        handler: ({ state: e, range: n, match: r, chain: o }) => {
            ...
            let u = s.doc.resolve(n.from - 1).nodeBefore;
            u &&
                u.type === t.type &&
                Ne(s.doc, n.from - 1) &&
...
function Ce(t) {
    return new Ng({
        ...
        handler: ({ state: e, range: n, match: r, pasteEvent: o }) => {
            let i = W(t.getAttributes, void 0, r, o);
            ...
            if (l) {
                ...
                f < n.to && s.delete(f, n.to),
                    ...
                    (c = n.from + u + l.length),
                    s.addMark(n.from + u, c, t.type.create(i || {})),
...
var Gs = class {
    ...
    updateOverlay() {
        let e = this.editorView.state.doc.resolve(this.cursorPos),
            ...
            s = i.width / o.offsetWidth,
            l = i.height / o.offsetHeight;
        if (n) {
            let d = e.nodeBefore,
                f = e.nodeAfter;
            if (d || f) {
                let h = this.editorView.nodeDOM(
                    this.cursorPos - (d ? d.nodeSize : 0),
                );
                if (h) {
...
var se = class t extends E {
    constructor(e) {
        super(e, e);
    }
    map(e, n) {
        let r = e.resolve(n.map(this.head));
        return t.valid(r) ? new t(r) : E.near(r);
    }
    content() {
        return M.empty;
    }
    ...
    static valid(e) {
        let n = e.parent;
        if (n.isTextblock || !qy(e) || !Gy(e)) return !1;
...
var Ys = class t {
    ...
    resolve(e) {
        ...
        return se.valid(n) ? new se(n) : E.near(n);
    }
};
function qy(t) {
...
function Xy(t, e, n) {
    ...
    return o && o.inside > -1 && O.isSelectable(t.state.doc.nodeAt(o.inside))
        ? !1
...
function Qy(t, e) {
    ...
    for (let s = r.length - 1; s >= 0; s--)
        o = w.from(r[s].createAndFill(null, o));
    let i = t.state.tr.replace(n.pos, n.pos, new M(o, 0, 0));
...
function Zy(t) {
    ...
    return (
        ...
        J.create(t.doc, [Y.widget(t.selection.head, e, { key: "gapcursor" })])
    );
}
var ho = 200,
    de = function () {};
de.prototype.append = function (e) {
    return e.length
        ? ((e = de.from(e)),
          (!this.length && e) ||
              (e.length < ho && this.leafAppend(e)) ||
              (this.length < ho && e.leafPrepend(this)) ||
              this.appendInner(e))
        : this;
};
...
de.prototype.slice = function (e, n) {
    return (
        e === void 0 && (e = 0),
...
de.prototype.forEach = function (e, n, r) {
    n === void 0 && (n = 0),
...
de.prototype.map = function (e, n, r) {
...
de.from = function (e) {
    return e instanceof de ? e : e && e.length ? new ad(e) : de.empty;
};
var ad = (function (t) {
    function e(r) {
...
var e0 = (function (t) {
        ...
        return (
            ...
            (e.prototype.forEachInner = function (r, o, i, s) {
                ...
                if (
                    (o < l &&
                        this.left.forEachInner(r, o, Math.min(i, l), s) ===
                            !1) ||
                    (i > l &&
            ...
            (e.prototype.appendInner = function (r) {
                return this.left.depth >=
                    Math.max(this.right.depth, r.depth) + 1
...
var t0 = 500,
    Yt = class t {
        ...
        popEvent(e, n) {
            ...
            let o, i;
            n &&
                ((o = this.remapping(r, this.items.length)),
                (i = o.maps.length));
            let s = e.tr,
                l,
                a,
                ...
                this.items.forEach(
                    (d, f) => {
                        ...
                        if (d.selection)
                            return (
                                (l = o
                                    ? d.selection.map(o.slice(i))
                                    : d.selection),
                                (a = new t(
                                    this.items
                                        .slice(0, r)
                                        .append(u.reverse().concat(c)),
                                    this.eventCount - 1,
                                )),
                                !1
                            );
        ...
        addTransform(e, n, r, o) {
            ...
            for (let u = 0; u < e.steps.length; u++) {
                let d = e.steps[u].invert(e.docs[u]),
                    f = new Qe(e.mapping.maps[u], d, n),
                    h;
                (h = a && a.merge(f)) &&
                    ((f = h), u ? i.pop() : (l = l.slice(0, l.length - 1))),
                    i.push(f),
                    n && (s++, (n = void 0)),
                    o || (a = f);
            }
            let c = s - r.depth;
            return c > r0 && ((l = n0(l, c)), (s -= c)), new t(l.append(i), s);
        }
        remapping(e, n) {
            let r = new Bn();
            return (
        ...
        compress(e = this.items.length) {
            ...
            return (
                    ...
                    (s, l) => {
                        if (l >= e) o.push(s), s.selection && i++;
                            ...
                            if ((r--, c && n.appendMap(c, r), a)) {
                                ...
                                u && i++;
                                let d = new Qe(c.invert(), a, u),
                                    f,
                                    h = o.length - 1;
                                (f = o.length && o[h].merge(d))
                                    ? (o[h] = f)
                                    : o.push(d);
                            }
                        } else s.map && r--;
                ...
                new t(Xs.from(o.reverse()), i)
            );
        }
    };
Yt.empty = new Yt(Xs.empty, 0);
function n0(t, e) {
    let n;
    return (
        t.forEach((r, o) => {
...
function o0(t, e, n, r) {
    ...
    n.getMeta(l0) && (t = new Ze(t.done, t.undone, null, 0, -1));
    let s = n.getMeta("appendedTransaction");
    if (n.steps.length == 0) return t;
    if (s && s.getMeta(Gt))
        return s.getMeta(Gt).redo
            ? new Ze(
                  t.done.addTransform(n, void 0, r, po(e)),
                  t.undone,
                  cd(n.mapping.maps),
                  t.prevTime,
                  t.prevComposition,
            ...
            : new Ze(
                  t.done,
                  t.undone.addTransform(n, void 0, r, po(e)),
                  null,
                  t.prevTime,
                  t.prevComposition,
              );
            ...
            a =
                ...
                (!s &&
                    ...
                    (t.prevTime < (n.time || 0) - r.newGroupDelay ||
                        !i0(n, t.prevRanges))),
            c = s ? Qs(t.prevRanges, n.mapping) : cd(n.mapping.maps);
        return new Ze(
            t.done.addTransform(
                n,
...
function s0(t, e, n) {
    let r = po(e),
        o = Gt.get(e).spec.config,
        i = (n ? t.undone : t.done).popEvent(e, r);
    if (!i) return null;
    let s = i.selection.resolve(i.transform.doc),
        l = (n ? t.done : t.undone).addTransform(
            i.transform,
            e.selection.getBookmark(),
            o,
            r,
        ),
        a = new Ze(n ? l : i.remaining, n ? i.remaining : l, null, 0, -1);
    return i.transform
        .setSelection(s)
        .setMeta(Gt, { redo: n, historyState: a });
}
var Zs = !1,
    ud = null;
function po(t) {
...
var Gt = new L("history"),
    l0 = new L("closeHistory");
function dd(t = {}) {
    return (
        ...
        new N({
            ...
            state: {
                init() {
                    return new Ze(Yt.empty, Yt.empty, null, 0, -1);
                },
                apply(e, n, r) {
                    return o0(n, r, e, t);
                },
...
var P1 = $.create({
                ...
                new N({
                    ...
                    filterTransaction: (e, n) => {
                        ...
                        if (
                            ...
                            return !0;
                        let o = this.storage.characters({ node: n.doc }),
    ...
    pd = $.create({
        ...
        extendNodeSchema(t) {
            ...
            return {
                allowGapCursor:
                    (e = W(I(t, "allowGapCursor", n))) != null ? e : null,
            };
        },
    }),
    nl = $.create({
                ...
                new N({
                    ...
                    props: {
                        decorations: ({ doc: t, selection: e }) => {
                            ...
                            return (
                                t.descendants((s, l) => {
                                    let a = r >= l && r <= l + s.nodeSize,
                                        c = !s.isLeaf && er(s);
                                    if (
                                        (a || !this.options.showOnlyCurrent) &&
                                        c
                                    ) {
                                        let u = [this.options.emptyNodeClass];
                                        i &&
                                            u.push(
                                                this.options.emptyEditorClass,
                                            );
                                        let d = Y.node(l, l + s.nodeSize, {
                                            class: u.join(" "),
                                            "data-placeholder":
                                                typeof this.options
            ...
            return [
                new N({
                    ...
                    appendTransaction: (n, r, o) => {
                        let { doc: i, tr: s, schema: l } = o,
                            a = t.getState(o),
                            c = i.content.size,
                            u = l.nodes[this.options.node];
                        if (a) return s.insert(c, u.create());
                    },
                    state: {
                        init: (n, r) => {
                            let o = r.tr.doc.lastChild;
                            return !fd({ node: o, types: e });
                        },
                        apply: (n, r) => {
...
var a0 = /^\s*>\s$/,
    c0 = z.create({
        ...
        addInputRules() {
            return [Xe({ find: a0, type: this.type })];
        },
    }),
    gd = c0;
var u0 = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/,
    d0 = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))/g,
    f0 = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))$/,
    h0 = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))/g,
    p0 = te.create({
        name: "bold",
        addOptions() {
            return { HTMLAttributes: {} };
        ...
        addInputRules() {
            return [
                Ie({ find: u0, type: this.type }),
                Ie({ find: f0, type: this.type }),
            ];
        },
        addPasteRules() {
            return [
                Ce({ find: d0, type: this.type }),
                Ce({ find: h0, type: this.type }),
            ];
        },
    }),
    yd = p0;
var m0 = /(^|[^`])`([^`]+)`(?!`)/,
    ...
    y0 = te.create({
        ...
        renderHTML({ HTMLAttributes: t }) {
            return ["code", T(this.options.HTMLAttributes, t), 0];
        },
        addCommands() {
            return {
                setCode:
        ...
        addInputRules() {
            return [Ie({ find: m0, type: this.type })];
        },
        addPasteRules() {
            return [Ce({ find: g0, type: this.type })];
        },
    }),
    bd = y0;
var b0 = /^```([a-z]+)?[\s\n]$/,
        ...
        addKeyboardShortcuts() {
            return {
                ...
                Enter: ({ editor: t }) => {
                    ...
                    let i = r.parentOffset === r.parent.nodeSize - 2,
...
`);
                ...
                ArrowDown: ({ editor: t }) => {
                    ...
                    return l === void 0
                        ...
                        : r.nodeAt(l)
                          ? t.commands.command(
                                ({ tr: c }) => (
                                    c.setSelection(E.near(r.resolve(l))), !0
                                ),
                            )
                          : t.commands.exitCode();
                },
        ...
        addProseMirrorPlugins() {
            return [
                new N({
                    key: new L("codeBlockVSCodeHandler"),
                    props: {
                        handlePaste: (t, e) => {
                            if (
                                !e.clipboardData ||
    ...
    addNodeView() {
        return ({
            ...
            if (
                ...
                (u.className = "fi-icon-btn"),
                    (u.type = "button"),
                    (u.innerHTML = i.options.editCustomBlockButtonIconHtml),
            ...
            if (
                ...
                let c = document.createElement("div");
                (c.className = "fi-fo-rich-editor-custom-block-delete-btn-ctn"),
                    l.appendChild(c);
                let u = document.createElement("button");
                (u.className = "fi-icon-btn"),
                    (u.type = "button"),
                    (u.innerHTML = i.options.deleteCustomBlockButtonIconHtml),
                    u.addEventListener("click", () =>
            ...
            if (e.attrs.preview) {
                ...
                (c.className =
                    ...
                    (c.innerHTML = new TextDecoder().decode(
                        Uint8Array.from(atob(e.attrs.preview), (u) =>
                            u.charCodeAt(0),
                        ),
                    )),
                    s.appendChild(c);
                ...
                props: {
                    handleDrop(e, n) {
                        if (
                            ...
                            return !1;
                        let r = n.dataTransfer.getData("customBlock");
                        return (
                            t(
                                r,
                                e.posAtCoords({
...
var go = (t, e) => e.view.domAtPos(t).node.offsetParent !== null,
    S0 = (t, e, n) => {
    ...
    Sd = (t, e) => {
        ...
        if (
            ...
            return !1;
        let u = Ye((y) => y.type === i.nodes.details)(s);
        if (!u) return !1;
        let d = Sn(u.node, (y) => y.type === i.nodes.detailsContent);
        if (!d.length || go(u.start + d[0].pos + 1, t)) return !1;
        let h = n.doc.resolve(u.pos + u.node.nodeSize),
            p = se.findFrom(h, 1, !1);
        if (!p) return !1;
        let { tr: m } = n,
            g = new se(p);
    ...
    kd = z.create({
        ...
        renderHTML({ HTMLAttributes: t }) {
            return ["details", T(this.options.HTMLAttributes, t), 0];
        },
        addNodeView() {
            return ({ editor: t, getPos: e, node: n, HTMLAttributes: r }) => {
                let o = document.createElement("div"),
                    i = T(this.options.HTMLAttributes, r, {
                        "data-type": this.name,
                    });
                Object.entries(i).forEach(([c, u]) => o.setAttribute(c, u));
                ...
                let a = (c) => {
                    if (c !== void 0)
                        if (c) {
                            if (
                                o.classList.contains(this.options.openClassName)
                            )
                                return;
                    ...
                    let u = new Event("toggleDetailsContent"),
                        d = l.querySelector(
                ...
                return (
                    ...
                    s.addEventListener("click", () => {
                        ...
                        if (t.isEditable && typeof e == "function") {
                            let { from: c, to: u } = t.state.selection;
                            t.chain()
                                .command(({ tr: d }) => {
                                    let f = e();
                                    if (!f) return !1;
                                    let h = d.doc.nodeAt(f);
                    ...
                    }),
                    {
                        ...
                        update: (c) =>
                            c.type !== this.type
                                ? !1
                                : (c.attrs.open !== void 0 && a(c.attrs.open),
                                  !0),
                    }
                );
            };
        ...
        addCommands() {
            return {
                setDetails:
                    ...
                    ({ state: t, chain: e }) => {
                        var n;
                        let { schema: r, selection: o } = t,
                            { $from: i, $to: s } = o,
                            l = i.blockRange(s);
                        if (!l) return !1;
                        let a = t.doc.slice(l.start, l.end);
                        if (
                ...
                unsetDetails:
                    ...
                    ({ state: t, chain: e }) => {
                        ...
                        let l = i[0],
                            ...
                            p = u.parent.type.contentMatch.defaultType,
                            g = [
        ...
        addKeyboardShortcuts() {
            return {
                ...
                Enter: ({ editor: t }) => {
                    ...
                    let s = go(i.after() + 1, t),
                        l = s ? e.doc.nodeAt(i.after()) : i.node(-2);
                    if (!l) return !1;
                    let a = s ? 0 : i.indexAfter(-1),
                        c = Zn(l.contentMatchAt(a));
                    if (!c || !l.canReplaceWith(a, a, c)) return !1;
                    let u = c.createAndFill();
                    if (!u) return !1;
                    let d = s ? i.after() + 1 : i.after(-1),
                        f = e.tr.replaceWith(d, d, u),
                        h = f.doc.resolve(d),
                        p = E.near(h, 1);
                    return (
                        f.setSelection(p), f.scrollIntoView(), n.dispatch(f), !0
                    );
                },
                ArrowRight: ({ editor: t }) => Sd(t, "right"),
                ArrowDown: ({ editor: t }) => Sd(t, "down"),
            };
        },
        addProseMirrorPlugins() {
            return [
                new N({
                    key: new L("detailsSelection"),
                    appendTransaction: (t, e, n) => {
                        let { editor: r, type: o } = this;
                        if (
                            !t.some((g) => g.selectionSet) ||
                            !e.selection.empty ||
                            !n.selection.empty ||
                            !Us(n, o.name)
                        )
                            return;
                        let { $from: l } = n.selection;
                        if (go(l.pos, r)) return;
                        let c = S0(l, (g) => g.type === o, r);
                        if (!c) return;
                        let u = Sn(
                            c.node,
                            (g) => g.type === n.schema.nodes.detailsSummary,
                        );
                        if (!u.length) return;
                        let d = u[0],
                            h =
    ...
    Cd = z.create({
        ...
        addNodeView() {
            return ({ HTMLAttributes: t }) => {
                let e = document.createElement("div"),
                    n = T(this.options.HTMLAttributes, t, {
                        "data-type": this.name,
                        hidden: "hidden",
                    });
                return (
            ...
            return {
                Enter: ({ editor: t }) => {
                    let { state: e, view: n } = t,
                        { selection: r } = e,
                        { $from: o, empty: i } = r,
                        s = Ye((_) => _.type === this.type)(r);
                    if (!i || !s || !s.node.childCount) return !1;
                    let l = o.index(s.depth),
                        { childCount: a } = s.node;
                    if (!(a === l + 1)) return !1;
                    let u = s.node.type.contentMatch.defaultType,
                        d = u?.createAndFill();
                    if (!d) return !1;
                    ...
                    let y = o.node(-3);
                    if (!y) return !1;
                    let b = o.indexAfter(-3),
                        x = Zn(y.contentMatchAt(b));
                    if (!x || !y.canReplaceWith(b, b, x)) return !1;
                    let C = x.createAndFill();
                    if (!C) return !1;
                    let { tr: S } = e,
                        R = o.after(-2);
                    S.replaceWith(R, R, C);
                    let P = S.doc.resolve(R),
                        v = E.near(P, 1);
                    S.setSelection(v);
                    let B = m,
                        D = m + p.nodeSize;
                    return (
                        S.delete(B, D), S.scrollIntoView(), n.dispatch(S), !0
                    );
                },
            };
        },
    ...
    Md = z.create({
        ...
        renderHTML({ HTMLAttributes: t }) {
            return ["summary", T(this.options.HTMLAttributes, t), 0];
        },
    });
var k0 = z.create({ name: "doc", topNode: !0, content: "block+" }),
    vd = k0;
var C0 = z.create({
        name: "hardBreak",
        addOptions() {
        ...
        renderHTML({ HTMLAttributes: t }) {
            return ["br", T(this.options.HTMLAttributes, t)];
        },
        renderText() {
            return `
`;
                ...
                setHardBreak:
                    ...
                    ({ commands: t, chain: e, state: n, editor: r }) =>
                        t.first([
                            ...
                            () =>
                                t.command(() => {
                                    let { selection: o, storedMarks: i } = n;
...
var v0 = /(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))$/,
    ...
    A0 = te.create({
        ...
        renderHTML({ HTMLAttributes: t }) {
            return ["mark", T(this.options.HTMLAttributes, t), 0];
        },
        addCommands() {
            return {
                setHighlight:
        ...
        addInputRules() {
            return [Ie({ find: v0, type: this.type })];
        },
        addPasteRules() {
            return [Ce({ find: T0, type: this.type })];
        },
    }),
    Ed = A0;
var E0 = z.create({
        ...
        renderHTML({ HTMLAttributes: t }) {
            return ["hr", T(this.options.HTMLAttributes, t)];
        },
        addCommands() {
            return {
                setHorizontalRule:
                    () =>
                    ({ chain: t, state: e }) => {
                        if (!rd(e, e.schema.nodes[this.name])) return !1;
                        let { selection: n } = e,
                            { $to: r } = n,
                            o = t();
                        return (
                                    ...
                                    if (s) {
                                        ...
                                        if (a.nodeAfter)
                                            a.nodeAfter.isTextblock
                                                ...
                                                : a.nodeAfter.isBlock
                                                  ? i.setSelection(
                                                        O.create(i.doc, a.pos),
                                                    )
                                                  : i.setSelection(
                                                        A.create(i.doc, a.pos),
                                                    );
                                        else {
                                            let u =
                                                (l =
        ...
        addInputRules() {
            return [
                uo({ find: /^(?:---|—-|___\s|\*\*\*\s)$/, type: this.type }),
            ];
        },
    }),
    Od = E0;
var O0 = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))$/,
    ...
    P0 = te.create({
        ...
        renderHTML({ HTMLAttributes: t }) {
            return ["em", T(this.options.HTMLAttributes, t), 0];
        },
        addCommands() {
            return {
                setItalic:
        ...
        addInputRules() {
            return [
                Ie({ find: O0, type: this.type }),
                Ie({ find: R0, type: this.type }),
            ];
        },
        addPasteRules() {
            return [
                Ce({ find: N0, type: this.type }),
                Ce({ find: D0, type: this.type }),
            ];
        },
    }),
...
var I0 = /(?:^|\s)(!\[(.+|:?)]\((\S+)(?:(?:\s+)["'](\S+)["'])?\))$/,
    L0 = z.create({
        ...
        renderHTML({ HTMLAttributes: t }) {
            return ["img", T(this.options.HTMLAttributes, t)];
        },
        addCommands() {
            return {
                setImage:
...
var Pd = z.create({
    ...
    renderHTML({ HTMLAttributes: t }) {
        return ["div", T(this.options.HTMLAttributes, t), 0];
    },
    addCommands() {
        return {
            toggleLead:
...
Me.prototype = {
    ...
    tr(t, e, n, r) {
        ...
        let o;
        return (
            e && e.j ? (o = e) : ((o = new Me(e)), n && r && Xt(e, n, r)),
            this.jr.push([t, o]),
            o
        );
    },
        ...
        if (
            ...
            if (r)
                if (s.t && typeof s.t == "string") {
                    let a = Object.assign(V0(s.t, r), n);
                    Xt(i, a, r);
                } else n && Xt(i, n, r);
            s.t = i;
        }
...
var F = (t, e, n, r, o) => t.ta(e, n, r, o),
    Z = (t, e, n, r, o) => t.tr(e, n, r, o),
    Id = (t, e, n, r, o) => t.ts(e, n, r, o),
    k = (t, e, n, r, o) => t.tt(e, n, r, o),
    bt = "WORD",
    hl = "UWORD",
    Vd = "ASCIINUMERICAL",
    Wd = "ALPHANUMERICAL",
    ...
    Mo = "CLOSEPAREN",
    vo = "OPENANGLEBRACKET",
    To = "CLOSEANGLEBRACKET",
    Ao = "FULLWIDTHLEFTPAREN",
    Eo = "FULLWIDTHRIGHTPAREN",
    Oo = "LEFTCORNERBRACKET",
    No = "RIGHTCORNERBRACKET",
    Ro = "LEFTWHITECORNERBRACKET",
    Do = "RIGHTWHITECORNERBRACKET",
    Po = "FULLWIDTHLESSTHAN",
    Io = "FULLWIDTHGREATERTHAN",
    Lo = "AMPERSAND",
    Bo = "APOSTROPHE",
    zo = "ASTERISK",
    Rt = "AT",
...
function j0(t = []) {
    ...
    yo == null && (yo = Bd(B0)),
        ...
        k(n, "\\", Ho),
        k(n, "\u30FB", _d);
    let r = Z(n, yt, yl, { [cl]: !0 });
    Z(r, yt, r);
    let o = Z(r, gt, Vd, { [or]: !0 }),
        i = Z(r, nr, Wd, { [rr]: !0 }),
        s = Z(n, gt, bt, { [ul]: !0 });
    Z(s, yt, o), Z(s, gt, s), Z(o, yt, o), Z(o, gt, o);
    let l = Z(n, nr, hl, { [dl]: !0 });
    Z(l, gt), Z(l, yt, i), Z(l, nr, l), Z(i, yt, i), Z(i, gt), Z(i, nr, i);
    let a = k(n, sl, bl, { [rl]: !0 }),
        c = k(n, Ld, gl, { [rl]: !0 }),
        u = Z(n, il, gl, { [rl]: !0 });
    k(n, ll, u),
        k(c, sl, a),
    ...
    for (let m = 0; m < yo.length; m++) Nt(n, yo[m], pl, bt, h);
    for (let m = 0; m < bo.length; m++) Nt(n, bo[m], ml, hl, p);
    Xt(pl, { tld: !0, ascii: !0 }, e),
        Xt(ml, { utld: !0, alpha: !0 }, e),
        Nt(n, "file", wo, bt, h),
        Nt(n, "mailto", wo, bt, h),
        Nt(n, "http", Cn, bt, h),
        Nt(n, "https", Cn, bt, h),
        Nt(n, "ftp", Cn, bt, h),
        Nt(n, "ftps", Cn, bt, h),
        Xt(wo, { scheme: !0, ascii: !0 }, e),
        Xt(Cn, { slashscheme: !0, ascii: !0 }, e),
    ...
    return (
        Id(n, "localhost", ur, { ascii: !0 }),
        (n.jd = new Me(Jo)),
        { start: n, tokens: Object.assign({ groups: e }, Kd) }
    );
}
function Ud(t, e) {
    let n = K0(e.replace(/[A-Z]/g, (l) => l.toLowerCase())),
        r = n.length,
        o = [],
        i = 0,
        s = 0;
    for (; s < r; ) {
        ...
        (i -= d),
            (s -= f),
            (c -= d),
            o.push({ t: u.t, v: e.slice(i - c, i), s: i - c, e: i });
    }
    return o;
}
function K0(t) {
...
function Nt(t, e, n, r, o) {
    ...
    for (let l = 0; l < s - 1; l++) {
        ...
        t.j[a]
            ? (i = t.j[a])
            : ((i = new Me(r)), (i.jr = o.slice()), (t.j[a] = i)),
            (t = i);
    }
    return (i = new Me(n)), (i.jr = o.slice()), (t.j[e[s - 1]] = i), i;
}
function Bd(t) {
    let e = [],
        n = [],
...
function Cl(t, e = null) {
    let n = Object.assign({}, dr);
    t && (n = Object.assign(n, t instanceof Cl ? t.o : t));
    let r = n.ignoreTags,
        o = [];
...
var Hd = qo("email", {
    ...
    xo = qo("url", {
        isLink: !0,
        toHref(t = dr.defaultProtocol) {
            return this.hasProtocol() ? this.v : `${t}://${this.v}`;
        },
        hasProtocol() {
            let t = this.tk;
            return t.length >= 2 && t[0].t !== ur && t[1].t === Dt;
        },
    });
var Le = (t) => new Me(t);
function J0({ groups: t }) {
    ...
    F(o, t.domain, s),
        ...
        F(s, t.domain, s);
    let c = k(s, Rt);
    k(i, Rt, c), k(l, Rt, c), k(a, Rt, c);
    let u = k(i, et);
    F(u, r, i), F(u, t.domain, i);
    let d = Le();
    F(c, t.domain, d), F(d, t.domain, d);
    let f = k(d, et);
    F(f, t.domain, d);
    let h = Le(Hd);
    F(f, t.tld, h), F(f, t.utld, h), k(c, ur, h);
    let p = k(d, Be);
    k(p, Be, p), F(p, t.domain, d), F(h, t.domain, d), k(h, et, f), k(h, Be, p);
    let m = k(h, Dt);
    F(m, t.numeric, Hd);
    let g = k(s, Be),
        y = k(s, et);
    k(g, Be, g), F(g, t.domain, s), F(y, r, i), F(y, t.domain, s);
    let b = Le(xo);
    F(y, t.tld, b),
        F(y, t.utld, b),
        F(b, t.domain, s),
    ...
    let S = Le(xo),
        R = Le();
    F(S, e, S), F(S, n, R), F(R, e, S), F(R, n, R), k(b, tt, S), k(C, tt, S);
    let P = k(l, Dt),
        v = k(a, Dt),
        B = k(v, tt),
        D = k(B, tt);
    ...
    return k(o, ur, b), k(o, bl, U0), { start: o, tokens: Kd };
}
function q0(t, e, n) {
    let r = n.length,
        o = 0,
    ...
    return s.length > 0 && i.push(al(Fd, e, s)), i;
}
function al(t, e, n) {
    let r = n[0].s,
        o = n[n.length - 1].e,
...
var G0 = (typeof console < "u" && console && console.warn) || (() => {}),
    Y0 =
...
function Ml(t, e = !1) {
    if (
        (q.initialized &&
            G0(
                `linkifyjs: already initialized - will not register custom scheme "${t}" ${Y0}`,
            ),
...
function X0() {
    q.scanner = j0(q.customSchemes);
    for (let t = 0; t < q.tokenQueue.length; t++)
        q.tokenQueue[t][1]({ scanner: q.scanner });
    q.parser = J0(q.scanner.tokens);
    for (let t = 0; t < q.pluginQueue.length; t++)
        q.pluginQueue[t][1]({ scanner: q.scanner, parser: q.parser });
    return (q.initialized = !0), q;
}
function Go(t) {
    return q.initialized || X0(), q0(q.parser.start, t, Ud(q.scanner.start, t));
}
Go.scan = Ud;
function Yo(t, e = null, n = null) {
    ...
    return new N({
        ...
        appendTransaction: (e, n, r) => {
            ...
            let { tr: s } = r,
                l = zs(n.doc, [...e]);
            if (
                (_s(l).forEach(({ newRange: c }) => {
                    let u = Eu(r.doc, c, (h) => h.isTextblock),
                        d,
                        f;
                    if (u.length > 1)
                        (d = u[0]),
                        ...
                        if (!Z0.test(h)) return;
                        (d = u[0]),
                            (f = r.doc.textBetween(d.pos, c.to, void 0, " "));
                    }
                    if (d && f) {
                        let h = f.split(Q0).filter(Boolean);
                        if (h.length <= 0) return !1;
                        let p = h[h.length - 1],
                            m = d.pos + f.lastIndexOf(p);
                        if (!p) return !1;
                        let g = Go(p).map((y) => y.toObject(t.defaultProtocol));
                        if (!tb(g)) return !1;
                        g.filter((y) => y.isLink)
                            .map((y) => ({
                                ...y,
    ...
    return new N({
        ...
        props: {
            handleClick: (e, n, r) => {
                ...
                if (!s) return !1;
                let l = Ws(e.state, t.type.name),
                    a = (o = s?.href) != null ? o : l.href,
                    c = (i = s?.target) != null ? i : l.target;
                return (
    ...
    return new N({
        ...
        props: {
            handlePaste: (e, n, r) => {
                ...
                let a = Yo(l, { defaultProtocol: t.defaultProtocol }).find(
                    (c) => c.isLink && c.value === l,
                );
                return !l || !a
                    ? !1
                    : t.editor.commands.setMark(t.type, { href: a.href });
            },
        },
    });
}
function Qt(t, e) {
    ...
    return (
        e &&
            e.forEach((r) => {
                let o = typeof r == "string" ? r : r.scheme;
                o && n.push(o);
            }),
        !t ||
            t
...
var ib = te.create({
        ...
        addOptions() {
            return {
                ...
                isAllowedUri: (t, e) => !!Qt(t, e.protocols),
                validate: (t) => !!t,
                shouldAutoLink: (t) => !!t,
            };
        },
        ...
        renderHTML({ HTMLAttributes: t }) {
            return this.options.isAllowedUri(t.href, {
                ...
                ? ["a", T(this.options.HTMLAttributes, t), 0]
                : ["a", T(this.options.HTMLAttributes, { ...t, href: "" }), 0];
        },
        addCommands() {
            return {
                setLink:
            ...
            return [
                Ce({
                    find: (t) => {
                        let e = [];
                        if (t) {
                            let { protocols: n, defaultProtocol: r } =
                                    this.options,
                                o = Yo(t).filter(
                                    (i) =>
                                        i.isLink &&
                                        this.options.isAllowedUri(i.value, {
                                            defaultValidate: (s) => !!Qt(s, n),
                                            protocols: n,
                                            defaultProtocol: r,
                                        }),
                                );
                    ...
                    t.push(
                        rb({
                            ...
                            enableClickSelection:
                                this.options.enableClickSelection,
                        }),
                    ),
...
var sb = Object.defineProperty,
    lb = (t, e) => {
        for (var n in e) sb(t, n, { get: e[n], enumerable: !0 });
    },
    ab = "listItem",
    Yd = "textStyle",
    Xd = /^\s*([-+*])\s$/,
    El = z.create({
        ...
        addInputRules() {
            let t = Xe({ find: Xd, type: this.type });
            return (
...
lb(cb, {
    ...
    hasListBefore: () => ef,
    hasListItemAfter: () => ub,
    hasListItemBefore: () => tf,
    listItemHasSubList: () => nf,
    nextListIsDeeper: () => rf,
    nextListIsHigher: () => of,
});
var fr = (t, e) => {
    ...
    Tl = (t, e, n) => {
        ...
        if (!Ge(t.state, e) && ef(t.state, e, n)) {
            let { $anchor: l } = t.state.selection,
            ...
            let u = c.at(-1);
            if (!u) return !1;
            let d = t.state.doc.resolve(a.start() + u.pos + 1);
            return t
                .chain()
        ...
        if (!Ge(t.state, e) || !Hu(t.state)) return !1;
        let r = fr(e, t.state);
        if (!r) return !1;
        let i = t.state.doc.resolve(r.$pos.pos - 2).node(r.depth),
            s = nf(e, t.state, i);
        return tf(e, t.state) && !s
    ...
    Al = (t, e) => {
        if (!Ge(t.state, e) || !zu(t.state, e)) return !1;
    ...
    Rl = z.create({
        ...
        renderHTML({ HTMLAttributes: t }) {
            let { start: e, ...n } = t;
            return e === 1
                ? ["ol", T(this.options.HTMLAttributes, n), 0]
                : ["ol", T(this.options.HTMLAttributes, t), 0];
        },
        addCommands() {
            return {
                toggleOrderedList:
        ...
        addAttributes() {
            return {
                checked: {
                    ...
                    keepOnSplit: !1,
                    parseHTML: (t) => {
                        let e = t.getAttribute("data-checked");
                        return e === "" || e === "true";
                    },
        ...
        addExtensions() {
            ...
            return (
                this.options.bulletList !== !1 &&
                    t.push(El.configure(this.options.bulletList)),
                this.options.listItem !== !1 &&
                    t.push(Ol.configure(this.options.listItem)),
                this.options.listKeymap !== !1 &&
                    t.push(db.configure(this.options.listKeymap)),
                this.options.orderedList !== !1 &&
                    t.push(Rl.configure(this.options.orderedList)),
                this.options.taskItem !== !1 &&
                    t.push(pb.configure(this.options.taskItem)),
                this.options.taskList !== !1 &&
                    t.push(mb.configure(this.options.taskList)),
                t
            );
        },
    });
var sf = ["image/png", "image/jpeg", "image/gif", "image/webp"],
    Xo = (t, e, n = {}) => {
        t.dom
            .closest("form")
            ?.dispatchEvent(
    ...
    gb = ({
        ...
        let i = (s) =>
            e().callSchemaComponentMethod(
                n,
                "getUploadedFileAttachmentTemporaryUrl",
                { attachment: s },
            );
        return new N({
            key: new L("localFiles"),
            props: {
                handleDrop(s, l) {
                    if (!l.dataTransfer?.files.length) return !1;
                    let a = Array.from(l.dataTransfer.files).filter((u) =>
                        sf.includes(u.type),
                    );
                    if (!a.length) return !1;
                    Xo(s, "form-processing-started", { message: o }),
                        l.preventDefault(),
                        l.stopPropagation();
                    let c = s.posAtCoords({ left: l.clientX, top: l.clientY });
                    return (
                        a.forEach((u, d) => {
                            t.setEditable(!1),
                                s.dom.dispatchEvent(
                            ...
                            let h = ("10000000-1000-4000-8000" + -1e11).replace(
                                /[018]/g,
                                (p) =>
                                    (
                                        p ^
                ...
                handlePaste(s, l) {
                    ...
                    let a = Array.from(l.clipboardData.files).filter((c) =>
                        sf.includes(c.type),
                    );
                    return a.length
                        ? (l.preventDefault(),
    ...
    lf = $.create({
        ...
        addProseMirrorPlugins() {
            return [gb({ editor: this.editor, ...this.options })];
        },
    });
function yb(t) {
    var e;
    ...
    let y = g.input.slice(Math.max(0, g.index - 1), g.index),
        b = new RegExp(`^[${i?.join("")}\0]?$`).test(y);
    if (i !== null && !b) return null;
    let x = m + g.index,
        C = x + g[0].length;
    return (
        a && u.test(p.slice(C - 1, C + 1)) && ((g[0] += " "), (C += 1)),
        x < l.pos && C >= l.pos
            ? {
                  range: { from: x, to: C },
        ...
        b = new N({
            ...
            view() {
                return {
                    update: async (x, C) => {
                        var S, R, P, v, B, D, _;
                        let H = (S = this.key) == null ? void 0 : S.getState(C),
                            j =
                                (R = this.key) == null
                                    ? void 0
                                    : R.getState(x.state),
                            U =
                                H.active &&
                                j.active &&
                                H.range.from !== j.range.from,
                            oe = !H.active && j.active,
                            X = H.active && !j.active,
                            G = !oe && !X && H.query !== j.query,
                            ie = oe || (U && G),
                            Te = G || U,
                            En = X || (U && G);
                        if (!ie && !Te && !En) return;
                        let rn = En && !ie ? H : j,
                            Xl = x.dom.querySelector(
                                `[data-decoration-id="${rn.decorationId}"]`,
                            );
                        (g = {
                            editor: e,
                            range: rn.range,
                            ...
                            items: [],
                            command: (xr) =>
                                d({ editor: e, range: rn.range, props: xr }),
                            decorationNode: Xl,
                            clientRect: Xl
                                ? () => {
                                      var xr;
                                      let { decorationId: Bh } =
                                              (xr = this.key) == null
                                                  ? void 0
                                                  : xr.getState(e.state),
                                          Ql = x.dom.querySelector(
                                              `[data-decoration-id="${Bh}"]`,
                                          );
                                      return (
                                          Ql?.getBoundingClientRect() || null
                                      );
                                  }
                                : null,
                        }),
                            ie &&
                                ((P = y?.onBeforeStart) == null ||
                                    P.call(y, g)),
                            Te &&
                                ((v = y?.onBeforeUpdate) == null ||
                                    v.call(y, g)),
                            (Te || ie) &&
                                (g.items = await f({
                                    editor: e,
                            ...
                            En && ((B = y?.onExit) == null || B.call(y, g)),
                            Te && ((D = y?.onUpdate) == null || D.call(y, g)),
                            ie && ((_ = y?.onStart) == null || _.call(y, g));
                    },
                    destroy: () => {
                        var x;
                        g && ((x = y?.onExit) == null || x.call(y, g));
                    },
                };
            },
            state: {
                ...
                apply(x, C, S, R) {
                    let { isEditable: P } = e,
                        ...
                        { empty: D, from: _ } = B,
                        H = { ...C };
                    if (((H.composing = v), P && (D || e.view.composing))) {
                        (_ < C.range.from || _ > C.range.to) &&
                            !v &&
                            !C.composing &&
                            (H.active = !1);
                        let j = m({
            ...
            props: {
                handleKeyDown(x, C) {
                    var S;
                    let { active: R, range: P } = b.getState(x.state);
                    return (
                        (R &&
                            ((S = y?.onKeyDown) == null
                                ? void 0
...
var wb = function ({
    ...
    cf = z.create({
        ...
        priority: 101,
        addStorage() {
            return { suggestions: [], getSuggestionFromChar: () => null };
        },
        addOptions() {
            return {
                HTMLAttributes: {},
                renderText({ node: t }) {
                    return `{{ ${t.attrs.label ?? t.attrs.id} }}`;
                },
                deleteTriggerWithBackspace: !1,
                renderHTML({ options: t, node: e }) {
                    return [
                        "span",
                        T(this.HTMLAttributes, t.HTMLAttributes),
        ...
        addProseMirrorPlugins() {
            return [
                ...this.storage.suggestions.map(af),
                new N({
                    props: {
                        handleDrop(t, e) {
                            if (
                                ...
                                return !1;
                            let n = e.dataTransfer.getData("mergeTag");
                            return (
                                t.dispatch(
                                    t.state.tr.insert(
                                        t.posAtCoords({
        ...
        onBeforeCreate() {
            (this.storage.suggestions = (
                ...
                (this.storage.getSuggestionFromChar = (t) => {
                    let e = this.storage.suggestions.find((n) => n.char === t);
                    return (
                        e ||
...
var Sb = z.create({
        ...
        renderHTML({ HTMLAttributes: t }) {
            return ["p", T(this.options.HTMLAttributes, t), 0];
        },
        addCommands() {
            return {
                setParagraph:
...
var kb = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))$/,
    ...
    Mb = te.create({
        ...
        renderHTML({ HTMLAttributes: t }) {
            return ["s", T(this.options.HTMLAttributes, t), 0];
        },
        addCommands() {
            return {
                setStrike:
        ...
        addInputRules() {
            return [Ie({ find: kb, type: this.type })];
        },
        addPasteRules() {
            return [Ce({ find: Cb, type: this.type })];
        },
    }),
    hf = Mb;
var vb = te.create({
        ...
        renderHTML({ HTMLAttributes: t }) {
            return ["sub", T(this.options.HTMLAttributes, t), 0];
        },
        addCommands() {
            return {
                setSubscript:
...
var Tb = te.create({
        ...
        renderHTML({ HTMLAttributes: t }) {
            return ["sup", T(this.options.HTMLAttributes, t), 0];
        },
        addCommands() {
            return {
                setSuperscript:
...
if (typeof WeakMap < "u") {
    let t = new WeakMap();
    (Pl = (e) => t.get(e)), (Il = (e, n) => (t.set(e, n), n));
} else {
    let t = [],
        n = 0;
    (Pl = (r) => {
...
var ee = class {
    ...
    nextCell(t, e, n) {
        let { left: r, right: o, top: i, bottom: s } = this.findCell(t);
        return e == "horiz"
    ...
    rectBetween(t, e) {
        let { left: n, right: r, top: o, bottom: i } = this.findCell(t),
            { left: s, right: l, top: a, bottom: c } = this.findCell(e);
        return {
            left: Math.min(n, s),
            top: Math.min(o, a),
            right: Math.max(r, l),
...
function Ab(t) {
    ...
    for (let c = 0, u = 0; c < n; c++) {
        ...
        for (let p = 0; ; p++) {
            ...
            let m = d.child(p),
                { colspan: g, rowspan: y, colwidth: b } = m.attrs;
            for (let x = 0; x < y; x++) {
                if (x + c >= n) {
                    (i || (i = [])).push({
...
function Ib(t, e, n) {
    let r = ye(e.type.schema).header_cell;
    for (let o = 0; o < t.height; o++)
        if (e.nodeAt(t.map[n + o * t.width]).type != r) return !1;
    return !0;
}
var K = class xt extends E {
    constructor(e, n = e) {
        let r = e.node(-1),
            o = ee.get(r),
            i = e.start(-1),
            ...
            l = e.node(0),
            a = o.cellsInRect(s).filter((u) => u != n.pos - i);
        a.unshift(n.pos - i);
        let c = a.map((u) => {
            let d = r.nodeAt(u);
            if (!d) throw RangeError(`No cell with offset ${u} found`);
            let f = i + u + 1;
            return new dn(l.resolve(f), l.resolve(f + d.content.size));
        });
    ...
    content() {
        ...
        for (let a = o.top; a < o.bottom; a++) {
            let c = [];
            for (
                let u = a * n.width + o.left, d = o.left;
                d < o.right;
                d++, u++
            ) {
                let f = n.map[u];
            ...
            s.push(e.child(a).copy(w.from(c)));
        }
        let l = this.isColSelection() && this.isRowSelection() ? e : s;
        return new M(w.from(l), 1, 1);
    }
    replace(e, n = M.empty) {
        let r = e.steps.length,
            o = this.ranges;
        for (let s = 0; s < o.length; s++) {
            let { $from: l, $to: a } = o[s],
                c = e.mapping.slice(r);
            e.replace(c.map(l.pos), c.map(a.pos), s ? M.empty : n);
        }
        let i = E.findFrom(e.doc.resolve(e.mapping.slice(r).map(this.to)), -1);
        i && e.setSelection(i);
    }
    replaceWith(e, n) {
        this.replace(e, new M(w.from(n), 0, 0));
    }
    forEachCell(e) {
    ...
    isRowSelection() {
        ...
        let s = o + this.$anchorCell.nodeAfter.attrs.colspan,
...
var Lb = class Af {
    ...
    map(e) {
        return new Af(e.map(this.anchor), e.map(this.head));
    }
    resolve(e) {
        let n = e.resolve(this.anchor),
...
function Bb(t) {
    if (!(t.selection instanceof K)) return null;
    let e = [];
    return (
        t.selection.forEachCell((n, r) => {
            e.push(Y.node(r, r + n.nodeSize, { class: "selectedCell" }));
        }),
        J.create(t.doc, e)
    );
}
function zb({ $from: t, $to: e }) {
...
function Fb(t, e, n) {
    let r = (e || t).selection,
        ...
        i,
        s;
    if (r instanceof O && (s = r.node.type.spec.tableRole)) {
        if (s == "cell" || s == "header_cell") i = K.create(o, r.from);
        else if (s == "row") {
            let l = o.resolve(r.from + 1);
            i = K.rowSelection(l, l);
        } else if (!n) {
            let l = ee.get(r.node),
                a = r.from + 1,
        ...
        r instanceof A && zb(r)
            ...
            : r instanceof A &&
              Hb(r) &&
              (i = A.create(o, r.$from.start(), r.$from.end()));
    return i && (e || (e = t.tr)).setSelection(i), e;
}
var $b = new L("fix-tables");
function Ef(t, e, n, r) {
    let o = t.childCount,
        i = e.childCount;
...
function Fl(t, e) {
    let n,
        r = (o, i) => {
            o.type.spec.tableRole == "table" && (n = Vb(t, o, i, n));
        };
    return (
        e ? e.doc != t.doc && Ef(e.doc, t.doc, 0, r) : t.doc.descendants(r), n
    );
}
function Vb(t, e, n, r) {
    let o = ee.get(e);
    ...
    for (let a = 0, c = n + 1; a < o.height; a++) {
        ...
        if (f > 0) {
            ...
            let p = [];
            for (let g = 0; g < f; g++) {
                let y = ye(t.schema)[h].createAndFill();
                y && p.push(y);
            }
            let m = (a == 0 || s == a - 1) && l == a ? c + 1 : d - 1;
            r.insert(r.mapping.map(m), p);
        }
        c = d;
    }
    return r.setMeta($b, { fixTables: !0 });
}
function nt(t) {
    let e = t.selection,
        n = ri(t),
...
function Of(t, { map: e, tableStart: n, table: r }, o) {
    let i = o > 0 ? -1 : 0;
    Ib(e, r, o + i) && (i = o == 0 || o == e.width ? null : 0);
...
function Wb(t, { map: e, table: n, tableStart: r }, o) {
    ...
    for (let s = 0; s < e.height; ) {
        ...
        if (
            ...
            let d = t.mapping.slice(i).map(r + a);
...
function _b(t, e, n) {
    var r;
    let o = ye(e.type.schema).header_cell;
...
function Pf(t, { map: e, tableStart: n, table: r }, o) {
    var i;
    let s = n;
    for (let c = 0; c < o; c++) s += r.child(c).nodeSize;
    let l = [],
        a = o > 0 ? -1 : 0;
    _b(e, r, o + a) && (a = o == 0 || o == e.height ? null : 0);
    for (let c = 0, u = e.width * o; c < e.width; c++, u++)
        if (o > 0 && o < e.height && e.map[u] == e.map[u - e.width]) {
            ...
            let d =
                    a == null
                        ? ye(r.type.schema).cell
                        : (i = r.nodeAt(e.map[u + a * e.width])) == null
                          ? void 0
                          : i.type,
                f = d?.createAndFill();
            f && l.push(f);
...
function Lf(t, e) {
    ...
    if (e) {
        let n = nt(t);
        e(Pf(t.tr, n, n.bottom));
    }
    return !0;
}
function jb(t, { map: e, table: n, tableStart: r }, o) {
    let i = 0;
...
function Bf(t, e) {
    ...
    if (e) {
        ...
        for (let o = n.bottom - 1; jb(r, n, o), o != n.top; o--) {
            let i = n.tableStart ? r.doc.nodeAt(n.tableStart - 1) : r.doc;
            if (!i) throw RangeError("No table found");
            (n.table = i), (n.map = ee.get(n.table));
        }
        e(r);
    }
    return !0;
    ...
    if (e) {
        ...
        for (let u = r.top; u < r.bottom; u++)
            for (let d = r.left; d < r.right; d++) {
                let f = o.map[u * o.width + d],
                    h = r.table.nodeAt(f);
                if (!(s[f] || !h))
                    if (((s[f] = !0), a == null)) (a = f), (c = h);
                    else {
                        gf(h) || (l = l.append(h.content));
        ...
        if (
            ...
            let u = a + 1 + c.content.size,
                d = gf(c) ? a + 1 : u;
            i.replaceWith(d + r.tableStart, u + r.tableStart, l);
        }
        i.setSelection(new K(i.doc.resolve(a + r.tableStart))), e(i);
    }
    return !0;
}
function Vl(t, e) {
    let n = ye(t.schema);
    return Ub(({ node: r }) => n[r.type.spec.tableRole])(t, e);
}
function Ub(t) {
    return (e, n) => {
        var r;
        ...
        if (o instanceof K) {
            ...
            if (((i = Rb(o.$from)), !i)) return !1;
            s = (r = Mn(o.$from)) == null ? void 0 : r.pos;
        }
        if (
            i == null ||
            s == null ||
        ...
        if (n) {
            ...
            d.setNodeMarkup(s, t({ node: i, row: u.top, col: u.left }), a[0]),
                o instanceof K &&
                    d.setSelection(
                        new K(
...
var ZC = vn("row", { useDeprecatedLogic: !0 }),
    eM = vn("column", { useDeprecatedLogic: !0 }),
    Hf = vn("cell", { useDeprecatedLogic: !0 });
function qb(t, e) {
    if (e < 0) {
        let n = t.nodeBefore;
        if (n) return t.pos - n.nodeSize;
        for (let r = t.index(-1) - 1, o = t.before(); r >= 0; r--) {
            let i = t.node(-1).child(r),
                s = i.lastChild;
...
function Wl(t) {
    return function (e, n) {
        ...
        if (n) {
            ...
            n(e.tr.setSelection(A.between(o, Pb(o))).scrollIntoView());
        }
        return !0;
    };
}
...
function Qo(t, e) {
    ...
    if (e) {
        let r = t.tr,
            o = ye(t.schema).cell.createAndFill().content;
        n.forEachCell((i, s) => {
            i.content.eq(o) ||
                r.replace(
                    r.mapping.map(s + 1),
    ...
    if (i == "row")
        for (let a = 0; a < e.childCount; a++) {
            let c = e.child(a).content,
                u = a ? 0 : Math.max(0, n - 1),
                d = a < e.childCount - 1 ? 0 : Math.max(0, r - 1);
            (u || d) && (c = Bl(ye(s).row, new M(c, u, d)).content), l.push(c);
        }
    else if (i == "cell" || i == "header_cell")
        l.push(n || r ? Bl(ye(s).row, new M(e, n, r)).content : e);
    else return null;
    return Yb(s, l);
}
function Yb(t, e) {
    ...
    for (let o = 0; o < e.length; o++) {
        ...
        for (let s = i.childCount - 1; s >= 0; s--) {
            let { rowspan: l, colspan: a } = i.child(s).attrs;
    ...
    for (let o = 0; o < n.length; o++)
        if ((o >= e.length && e.push(w.empty), n[o] < r)) {
            let i = ye(t).cell.createAndFill(),
                s = [];
            for (let l = n[o]; l < r; l++) s.push(i);
            e[o] = e[o].append(w.from(s));
        }
    return { height: e.length, width: r, rows: e };
}
function Bl(t, e) {
    let n = t.createAndFill();
    return new kt(n).replace(0, n.content.size, e).doc;
}
function Xb({ width: t, height: e, rows: n }, r, o) {
    if (t != r) {
        let i = [],
            s = [];
            ...
            for (let u = i[l] || 0, d = 0; u < r; d++) {
                ...
                u + f.attrs.colspan > r &&
                    (f = f.type.createChecked(
                        Zt(f.attrs, f.attrs.colspan, u + f.attrs.colspan - r),
                        f.content,
                    )),
                    c.push(f),
                    (u += f.attrs.colspan);
...
function Qb(t, e, n, r, o, i, s) {
    ...
    if (i > e.height) {
        ...
        for (
            ...
            d.push(
                g
                    ? u || (u = a.header_cell.createAndFill())
                    : c || (c = a.cell.createAndFill()),
            );
        }
        let f = a.row.create(null, w.from(d)),
            h = [];
    ...
    for (let c = o; c < i; c++) {
        ...
        if (e.map[u - 1] == d) {
            ...
            t.setNodeMarkup(
                p,
                null,
                Zt(f.attrs, s - h, f.attrs.colspan - (s - h)),
            ),
                t.insert(
                    p + f.nodeSize,
                    f.type.createAndFill(Zt(f.attrs, 0, s - h)),
                ),
                (c += f.attrs.rowspan - 1);
        }
    }
...
function wf(t, e, n, r, o) {
    ...
    function h() {
        ...
        (s = ee.get(i)), (f = d.mapping.maps.length);
    }
    Qb(d, s, i, n, c, u, f) && h(),
        bf(d, s, i, n, a, c, l, f) && h(),
        bf(d, s, i, n, a, c, u, f) && h(),
        xf(d, s, i, n, l, u, a, f) && h(),
        xf(d, s, i, n, l, u, c, f) && h();
    for (let p = l; p < u; p++) {
...
function Zo(t, e) {
    return (n, r, o) => {
        if (!o) return !1;
        let i = n.selection;
        if (i instanceof K) return ti(n, r, E.near(i.$headCell, e));
        if (t != "horiz" && !i.empty) return !1;
        let s = $f(o, t, e);
        if (s == null) return !1;
        if (t == "horiz") return ti(n, r, E.near(n.doc.resolve(i.head + e), e));
        {
            ...
            return (
                a
                    ? (c = E.near(a, 1))
                    : e < 0
                      ? (c = E.near(n.doc.resolve(l.before(-1)), -1))
                      : (c = E.near(n.doc.resolve(l.after(-1)), 1)),
                ti(n, r, c)
            );
        }
    };
...
function ei(t, e) {
    return (n, r, o) => {
        ...
        let i = n.selection,
            s;
        if (i instanceof K) s = i;
        else {
            let a = $f(o, t, e);
            if (a == null) return !1;
            s = new K(n.doc.resolve(a));
        }
        let l = vf(s.$headCell, t, e);
        return l ? ti(n, r, new K(s.$anchorCell, l)) : !1;
    };
}
function ex(t, e) {
    let n = t.state.doc,
        r = Mn(n.resolve(e));
    return r ? (t.dispatch(t.state.tr.setSelection(new K(r))), !0) : !1;
}
function tx(t, e, n) {
    ...
    if (o instanceof K) {
        r ||
            (r = {
                width: 1,
                height: 1,
                rows: [w.from(Bl(ye(t.state.schema).cell, n))],
            });
        ...
        return (
            (r = Xb(r, l.right - l.left, l.bottom - l.top)),
            wf(t.state, t.dispatch, s, l, r),
            !0
        );
    } else if (r) {
        let i = ri(t.state),
        ...
        return (
            wf(
                ...
                t.dispatch,
                s,
                ee.get(i.node(-1)).findCell(i.pos - s),
                r,
            ),
            !0
        );
...
function nx(t, e) {
    ...
    function s() {
        t.root.removeEventListener("mouseup", s),
            ...
            Pt.getState(t.state) != null &&
                t.dispatch(t.state.tr.setMeta(Pt, -1));
    }
    function l(a) {
        let c = a,
            u = Pt.getState(t.state),
            d;
        if (u != null) d = t.state.doc.resolve(u);
        else if (Sf(t, c.target) != r && ((d = Dl(t, e)), !d)) return s();
        d && i(d, c);
    }
...
function Dl(t, e) {
    ...
    return n && n ? Mn(t.state.doc.resolve(n.pos)) : null;
}
var rx = class {
    constructor(t, e) {
        (this.node = t),
            ...
            zl(t, this.colgroup, this.table, e),
    ...
    update(t) {
        return t.type != this.node.type
            ? !1
            : ((this.node = t),
              zl(t, this.colgroup, this.table, this.defaultCellMinWidth),
              !0);
    }
    ignoreMutation(t) {
        return (
...
function zl(t, e, n, r, o, i) {
    ...
    if (u) {
        for (let d = 0, f = 0; d < u.childCount; d++) {
            let { colspan: h, colwidth: p } = u.child(d).attrs;
            for (let m = 0; m < h; m++, f++) {
                let g = o == f ? i : p && p[m],
                    y = g ? g + "px" : "";
                if (((l += g || r), g || (a = !1), c))
...
var Ee = new L("tableColumnResizing");
function Vf({
    handleWidth: t = 5,
    cellMinWidth: e = 25,
    ...
    let i = new N({
            ...
            init(s, l) {
                ...
                let u =
                        (c = (a = i.spec) == null ? void 0 : a.props) == null
                            ? void 0
                            : c.nodeViews,
                    d = ye(l.schema).table.name;
                return (
                    r && u && (u[d] = (f, h) => new r(f, n, h)), new ox(-1, !1)
                );
            },
            apply(s, l) {
                return l.apply(s);
        ...
        props: {
            ...
            decorations: (s) => {
                let l = Ee.getState(s);
                if (l && l.activeHandle > -1) return fx(s, l.activeHandle);
            },
            nodeViews: {},
        },
    });
...
var ox = class ni {
    ...
    apply(e) {
        let n = this,
            r = e.getMeta(Ee);
        if (r && r.setHandle != null) return new ni(r.setHandle, !1);
        if (r && r.setDragging !== void 0)
            return new ni(n.activeHandle, r.setDragging);
        if (n.activeHandle > -1 && e.docChanged) {
            let o = e.mapping.map(n.activeHandle, -1);
            return Ll(e.doc.resolve(o)) || (o = -1), new ni(o, n.dragging);
        }
        return n;
    }
};
function ix(t, e, n, r) {
    ...
    if (o && !o.dragging) {
        ...
        if (i) {
            ...
            e.clientX - l <= n
                ? (s = kf(t, e, "left", n))
                : a - e.clientX <= n && (s = kf(t, e, "right", n));
        }
        if (s != o.activeHandle) {
            if (!r && s !== -1) {
                let l = t.state.doc.resolve(s),
                    ...
                    u = l.start(-1);
                if (
                    c.colCount(l.pos - u) + l.nodeAfter.attrs.colspan - 1 ==
                    c.width - 1
                )
                    return;
            }
...
function sx(t) {
    if (!t.editable) return;
    let e = Ee.getState(t.state);
    e && e.activeHandle > -1 && !e.dragging && Wf(t, -1);
}
function lx(t, e, n, r) {
    var o;
    if (!t.editable) return !1;
    let i = (o = t.dom.ownerDocument.defaultView) != null ? o : window,
        s = Ee.getState(t.state);
    if (!s || s.activeHandle == -1 || s.dragging) return !1;
    let l = t.state.doc.nodeAt(s.activeHandle),
        a = ax(t, s.activeHandle, l.attrs);
    t.dispatch(
    ...
    function c(d) {
        ...
        f?.dragging &&
            (ux(t, f.activeHandle, Cf(f.dragging, d, n)),
    ...
    function u(d) {
        ...
        let f = Ee.getState(t.state);
        if (f && f.dragging) {
            let h = Cf(f.dragging, d, n);
            Mf(t, f.activeHandle, h, r);
        }
    }
    return (
        Mf(t, s.activeHandle, a, r),
...
function ax(t, e, { colspan: n, colwidth: r }) {
...
function ux(t, e, n) {
    ...
    for (let c = 0; c < i.height; c++) {
        ...
        let d = i.map[u],
            f = o.nodeAt(d).attrs,
            h = f.colspan == 1 ? 0 : l - i.colCount(d);
        if (f.colwidth && f.colwidth[h] == n) continue;
        let p = f.colwidth ? f.colwidth.slice() : dx(f.colspan);
...
function Mf(t, e, n, r) {
    let o = t.state.doc.resolve(e),
        i = o.node(-1),
        s = o.start(-1),
        l = ee.get(i).colCount(o.pos - s) + o.nodeAfter.attrs.colspan - 1,
        a = t.domAtPos(o.start(-1)).node;
    for (; a && a.nodeName != "TABLE"; ) a = a.parentNode;
    a && zl(i, a.firstChild, a, r, l, n);
}
function dx(t) {
...
function fx(t, e) {
    ...
    let s = ee.get(i),
        l = o.start(-1),
        a = s.colCount(o.pos - l) + o.nodeAfter.attrs.colspan - 1;
    for (let c = 0; c < s.height; c++) {
        let u = a + c * s.width;
        if (
            (a == s.width - 1 || s.map[u] != s.map[u + 1]) &&
            (c == 0 || s.map[u] != s.map[u - s.width])
        ) {
            let d = s.map[u],
                f = l + d + i.nodeAt(d).nodeSize - 1,
                h = document.createElement("div");
            (h.className = "column-resize-handle"),
                (n = Ee.getState(t)) != null &&
                    n.dragging &&
                    r.push(
                        Y.node(l + d, l + d + i.nodeAt(d).nodeSize, {
    ...
    return J.create(t.doc, r);
}
function _f({ allowTableNodeSelection: t = !1 } = {}) {
    return new N({
        key: Pt,
        state: {
            init() {
        ...
        props: {
            decorations: Bb,
            handleDOMEvents: { mousedown: nx },
            createSelectionBetween(e) {
                return Pt.getState(e.state) != null ? e.state.selection : null;
            },
            handleTripleClick: ex,
            handleKeyDown: Zb,
            handlePaste: tx,
        },
        appendTransaction(e, n, r) {
            return Fb(r, Fl(r, n), t);
        },
    });
}
var hx = z.create({
        ...
        renderHTML({ HTMLAttributes: t }) {
            return ["td", T(this.options.HTMLAttributes, t), 0];
        },
    }),
    px = z.create({
        name: "tableHeader",
        ...
        renderHTML({ HTMLAttributes: t }) {
            return ["th", T(this.options.HTMLAttributes, t), 0];
        },
    }),
    mx = z.create({
        name: "tableRow",
        ...
        renderHTML({ HTMLAttributes: t }) {
            return ["tr", T(this.options.HTMLAttributes, t), 0];
        },
    });
function _l(t, e) {
        ...
        for (let d = 0, f = 0; d < u.childCount; d += 1) {
            ...
            for (let m = 0; m < h; m += 1, f += 1) {
                ...
                if (((l += g || r), g || (a = !1), c)) {
                    if (c.style.width !== y) {
                        let [b, x] = _l(r, g);
                        c.style.setProperty(b, x);
                    }
                    c = c.nextSibling;
                } else {
                    let b = document.createElement("col"),
                        [x, C] = _l(r, g);
                    b.style.setProperty(x, C), e.appendChild(b);
                }
            }
        }
    for (; c; ) {
...
var gx = class {
    constructor(t, e) {
        (this.node = t),
            ...
            jf(t, this.colgroup, this.table, e),
            (this.contentDOM = this.table.appendChild(
                document.createElement("tbody"),
            ));
    }
    update(t) {
        return t.type !== this.node.type
            ? !1
            : ((this.node = t),
              jf(t, this.colgroup, this.table, this.cellMinWidth),
              !0);
    }
    ignoreMutation(t) {
        return (
...
function yx(t, e, n, r) {
    ...
    for (let d = 0, f = 0; d < l.childCount; d += 1) {
        let { colspan: h, colwidth: p } = l.child(d).attrs;
        for (let m = 0; m < h; m += 1, f += 1) {
            let g = n === f ? r : p && p[m];
            (o += g || e), g || (i = !1);
            let [y, b] = _l(e, g);
...
var oi = ({ editor: t }) => {
        ...
        if (!wx(e)) return !1;
        let n = 0,
            r = Hs(e.ranges[0].$from, (i) => i.type.name === "table");
        return (
    ...
    Sx = z.create({
        ...
        renderHTML({ node: t, HTMLAttributes: e }) {
            let {
                ...
                tableWidth: r,
                tableMinWidth: o,
            } = yx(t, this.options.cellMinWidth);
            return [
                "table",
                T(this.options.HTMLAttributes, e, {
        ...
        addCommands() {
            return {
                insertTable:
                    ...
                    ({ tr: r, dispatch: o, editor: i }) => {
                        let s = xx(i.schema, t, e, n);
                        if (o) {
                            let l = r.selection.from + 1;
                            r.replaceSelectionWith(s)
                                .scrollIntoView()
                                .setSelection(A.near(r.doc.resolve(l)));
                        }
                        return !0;
                    },
                addColumnBefore:
                ...
                fixTables:
                    () =>
                    ({ state: t, dispatch: e }) => (e && Fl(t), !0),
                setCellSelection:
                    (t) =>
                    ({ tr: e, dispatch: n }) => {
                        if (n) {
                            let r = K.create(e.doc, t.anchorCell, t.headCell);
                            e.setSelection(r);
                        }
                        return !0;
                    },
        ...
        extendNodeSchema(t) {
            ...
            return { tableRole: W(I(t, "tableRole", e)) };
        },
    }),
    Uf = $.create({
        name: "tableKit",
        addExtensions() {
            ...
            return (
                this.options.table !== !1 &&
                    t.push(Sx.configure(this.options.table)),
                this.options.tableCell !== !1 &&
                    t.push(hx.configure(this.options.tableCell)),
                this.options.tableHeader !== !1 &&
                    t.push(px.configure(this.options.tableHeader)),
                this.options.tableRow !== !1 &&
                    t.push(mx.configure(this.options.tableRow)),
                t
            );
        },
    });
var kx = z.create({ name: "text", group: "inline" }),
    Jf = kx;
var Cx = $.create({
        name: "textAlign",
        addOptions() {
...
var Mx = te.create({
        ...
        renderHTML({ HTMLAttributes: t }) {
            return ["u", T(this.options.HTMLAttributes, t), 0];
        },
        addCommands() {
            return {
                setUnderline:
    ...
    Gf = Mx;
var jl = ["top", "right", "bottom", "left"],
    Yf = ["start", "end"],
    Kl = jl.reduce((t, e) => t.concat(e, e + "-" + Yf[0], e + "-" + Yf[1]), []),
    ze = Math.min,
    fe = Math.max,
    mr = Math.round;
var _e = (t) => ({ x: t, y: t }),
    vx = { left: "right", right: "left", bottom: "top", top: "bottom" },
    Tx = { start: "end", end: "start" };
function ii(t, e, n) {
    return fe(t, ze(e, n));
}
function rt(t, e) {
...
var Ax = new Set(["top", "bottom"]);
function je(t) {
    return Ax.has(Oe(t)) ? "y" : "x";
}
function li(t) {
    return Ul(je(t));
}
        ...
        s =
            o === "x"
                ...
                : r === "start"
                  ? "bottom"
                  : "top";
    return e.reference[i] > e.floating[i] && (s = pr(s)), [s, pr(s)];
}
function Zf(t) {
    let e = pr(t);
    return [hr(t), e, hr(e)];
...
function hr(t) {
    return t.replace(/start|end/g, (e) => Tx[e]);
}
var Xf = ["left", "right"],
    Qf = ["right", "left"],
    Ex = ["top", "bottom"],
...
function eh(t, e, n, r) {
    let o = He(t),
        i = Nx(Oe(t), n === "start", r);
    return (
        o && ((i = i.map((s) => s + "-" + o)), e && (i = i.concat(i.map(hr)))),
        i
    );
}
function pr(t) {
    return t.replace(/left|right|bottom|top/g, (e) => vx[e]);
}
function Rx(t) {
...
function wt(t) {
    let { x: e, y: n, width: r, height: o } = t;
    return {
        width: r,
        height: o,
        top: n,
...
var oh = async (t, e, n) => {
    let {
        ...
        c = await s.getElementRects({ reference: t, floating: e, strategy: o }),
        { x: u, y: d } = th(c, r, a),
        f = r,
        h = {},
        p = 0;
...
async function en(t, e) {
    ...
    let { x: r, y: o, platform: i, rects: s, elements: l, strategy: a } = t,
        ...
        p = ai(h),
        g = l[f ? (d === "floating" ? "reference" : "floating") : d],
        y = wt(
        ...
        S = wt(
            i.convertOffsetParentRelativeRectToViewportRelativeRect
                ? await i.convertOffsetParentRelativeRectToViewportRelativeRect(
                      { elements: l, rect: b, offsetParent: x, strategy: a },
                  )
                : b,
        );
    return {
...
var ih = (t) => ({
    ...
    async fn(e) {
        ...
        let d = ai(u),
            ...
            C = i.reference[p] + i.reference[h] - f[h] - i.floating[p],
            S = f[h] - i.reference[h],
            R = await (s.getOffsetParent == null
                ? void 0
                : s.getOffsetParent(c)),
            P = R ? R[x] : 0;
        (!P || !(await (s.isElement == null ? void 0 : s.isElement(R)))) &&
            (P = l.floating[x] || i.floating[p]);
        let v = C / 2 - S / 2,
            B = P / 2 - m[p] / 2 - 1,
            D = ze(d[y], B),
            _ = ze(d[b], B),
            ...
            X =
                ...
                He(o) != null &&
                U !== oe &&
                i.reference[p] / 2 - (U < H ? D : _) - m[p] / 2 < 0,
            G = X ? (U < H ? U - H : U - j) : 0;
        return {
            [h]: f[h] + G,
            data: {
...
function Dx(t, e, n) {
    return (
        t
            ? [...n.filter((o) => He(o) === t), ...n.filter((o) => He(o) !== t)]
            : n.filter((o) => Oe(o) === o)
    ).filter((o) => (t ? He(o) === t || (e ? hr(o) !== o : !1) : !0));
}
var sh = function (t) {
        return (
            t === void 0 && (t = {}),
                ...
                async fn(e) {
                    ...
                    let {
                        ...
                        } = e,
                        {
                            crossAxis: u = !1,
                            alignment: d,
                            allowedPlacements: f = Kl,
                            autoAlignment: h = !0,
                            ...p
                        } = rt(t, e),
                        m = d !== void 0 || f === Kl ? Dx(d || null, h, f) : f,
                        g = await en(e, p),
                        y =
                    ...
                    let C = [g[Oe(b)], g[x[0]], g[x[1]]],
                        S = [
                            ...(((r = s.autoPlacement) == null
                                ? void 0
                                : r.overflows) || []),
                            { placement: b, overflows: C },
                        ],
                        R = m[y + 1];
                    if (R)
                        return {
            ...
            t === void 0 && (t = {}),
            {
                ...
                async fn(e) {
                    ...
                    let y = Oe(o),
                        b = je(l),
                        x = Oe(l) === l,
                        C = await (a.isRTL == null
                            ? void 0
                            : a.isRTL(c.floating)),
                        S = f || (x || !m ? [pr(l)] : Zf(l)),
                        R = p !== "none";
                    !f && R && S.push(...eh(l, m, p, C));
                    let P = [l, ...S],
                        v = await en(e, g),
                        B = [],
                    ...
                    if (
                        ((D = [...D, { placement: o, overflows: B }]),
                        !B.every((U) => U <= 0))
                    ) {
                        var _, H;
                        let U =
                                (((_ = i.flip) == null ? void 0 : _.index) ||
                                    0) + 1,
                            oe = P[U];
                        if (
                            oe &&
                            (!(d === "alignment" ? b !== je(oe) : !1) ||
                                D.every(
                                    (ie) =>
                                        ie.overflows[0] > 0 &&
                                        je(ie.placement) === b,
                            ...
                            return {
                                data: { index: U, overflows: D },
                                reset: { placement: oe },
                            };
                        let X =
                            (H = D.filter((G) => G.overflows[0] <= 0).sort(
                                (G, ie) => G.overflows[1] - ie.overflows[1],
                            )[0]) == null
                                ? void 0
                                : H.placement;
                        if (!X)
                        ...
                        if (o !== X) return { reset: { placement: X } };
                    }
                    return {};
                },
            }
...
var ah = function (t) {
    return (
        t === void 0 && (t = {}),
        {
            ...
            async fn(e) {
                let { rects: n } = e,
                    { strategy: r = "referenceHidden", ...o } = rt(t, e);
                switch (r) {
                    case "referenceHidden": {
                        ...
                        return {
                            data: {
                                ...
                                referenceHidden: rh(s),
                            },
                        };
                    }
                    case "escaped": {
                        let i = await en(e, { ...o, altBoundary: !0 }),
                            s = nh(i, n.floating);
                        return { data: { escapedOffsets: s, escaped: rh(s) } };
                    }
                    default:
                        return {};
                }
                ...
                async fn(e) {
                    ...
                    function p() {
                        ...
                        if (d.length >= 2) {
                            ...
                            let g = Oe(n) === "left",
                                y = fe(...d.map((D) => D.right)),
                                b = ze(...d.map((D) => D.left)),
                                x = d.filter((D) =>
                                    g ? D.left === b : D.right === y,
                                ),
                                C = x[0].top,
                                S = x[x.length - 1].bottom,
                                R = b,
                                P = y,
                                v = P - R,
                                B = S - C;
    ...
    return (
        t === void 0 && (t = {}),
        {
            ...
            async fn(e) {
                    ...
                    ? ((g = d),
                      (y =
                          ...
                          ((await (s.isRTL == null
                              ...
                              ? "left"
                              : "right"))
                    : ((y = d), (g = f === "end" ? "top" : "bottom"));
                let b = m - u.top - u.bottom,
                    x = p - u.left - u.right,
                    C = ze(m - u[g], b),
                    S = ze(p - u[y], x),
                ...
                await a({ ...e, availableWidth: v, availableHeight: P });
                let B = await s.getDimensions(l.floating);
...
function tn(t) {
    return mh(t) ? (t.nodeName || "").toLowerCase() : "#document";
}
function ve(t) {
    var e;
    return (
...
function ot(t) {
    var e;
    return (e = (mh(t) ? t.ownerDocument : t.document) || window.document) ==
        null
        ? void 0
        : e.documentElement;
}
function mh(t) {
    return ui() ? t instanceof Node || t instanceof ve(t).Node : !1;
}
function Fe(t) {
    return ui() ? t instanceof Element || t instanceof ve(t).Element : !1;
}
function Ke(t) {
    return ui()
        ? t instanceof HTMLElement || t instanceof ve(t).HTMLElement
        : !1;
}
function ph(t) {
    return !ui() || typeof ShadowRoot > "u"
        ? !1
        : t instanceof ShadowRoot || t instanceof ve(t).ShadowRoot;
}
var Bx = new Set(["inline", "contents"]);
function Tn(t) {
    let { overflow: e, overflowX: n, overflowY: r, display: o } = $e(t);
    return /auto|scroll|overlay|hidden|clip/.test(e + r + n) && !Bx.has(o);
}
var zx = new Set(["table", "td", "th"]);
function gh(t) {
    return zx.has(tn(t));
}
var Hx = [":popover-open", ":modal"];
function gr(t) {
    return Hx.some((e) => {
        try {
            return t.matches(e);
...
var Fx = ["transform", "translate", "scale", "rotate", "perspective"],
    $x = ["transform", "translate", "scale", "rotate", "perspective", "filter"],
    Vx = ["paint", "layout", "strict", "content"];
function di(t) {
    let e = fi(),
        n = Fe(t) ? $e(t) : t;
    return (
        Fx.some((r) => (n[r] ? n[r] !== "none" : !1)) ||
        (n.containerType ? n.containerType !== "normal" : !1) ||
        (!e && (n.backdropFilter ? n.backdropFilter !== "none" : !1)) ||
        (!e && (n.filter ? n.filter !== "none" : !1)) ||
        $x.some((r) => (n.willChange || "").includes(r)) ||
        Vx.some((r) => (n.contain || "").includes(r))
    );
}
function yh(t) {
    let e = St(t);
...
var Wx = new Set(["html", "body", "#document"]);
function nn(t) {
    return Wx.has(tn(t));
}
function $e(t) {
...
function St(t) {
    if (tn(t) === "html") return t;
    let e = t.assignedSlot || t.parentNode || (ph(t) && t.host) || ot(t);
    return ph(e) ? e.host : e;
}
function bh(t) {
    let e = St(t);
    return nn(e)
...
function An(t) {
    ...
    let n = e.getBoundingClientRect(),
        { width: r, height: o, $: i } = Sh(e),
        s = (i ? mr(n.width) : n.width) / r,
        l = (i ? mr(n.height) : n.height) / o;
    return (
...
function br(t, e, n, r) {
    ...
    let o = t.getBoundingClientRect(),
        i = kh(t),
        s = _e(1);
    e && (r ? Fe(r) && (s = An(r)) : (s = An(t)));
    let l = jx(i, n, r) ? Ch(i) : _e(0),
        a = (o.left + l.x) / s.x,
        c = (o.top + l.y) / s.y,
        u = o.width / s.x,
        d = o.height / s.y;
    if (i) {
        ...
        for (; m && r && h !== p; ) {
            let g = An(m),
                ...
                b = $e(m),
                x = y.left + (m.clientLeft + parseFloat(b.paddingLeft)) * g.x,
                C = y.top + (m.clientTop + parseFloat(b.paddingTop)) * g.y;
            (a *= g.x),
                (c *= g.y),
                (u *= g.x),
                (d *= g.y),
    ...
    return wt({ width: u, height: d, x: a, y: c });
}
function Gl(t, e) {
    let n = yr(t).scrollLeft;
    return e ? e.left + n : br(ot(t)).left + n;
}
function Mh(t, e, n) {
    n === void 0 && (n = !1);
    let r = t.getBoundingClientRect(),
        o = r.left + e.scrollLeft - (n ? 0 : Gl(t, r)),
        i = r.top + e.scrollTop;
    return { x: o, y: i };
}
function Kx(t) {
    ...
    if (
        (d || (!d && !i)) &&
        ((tn(r) !== "body" || Tn(s)) && (a = yr(r)), Ke(r))
    ) {
        let h = br(r);
        (c = An(r)), (u.x = h.x + r.clientLeft), (u.y = h.y + r.clientTop);
    }
    let f = s && !d && !i ? Mh(s, a, !0) : _e(0);
    return {
        width: n.width * c.x,
        height: n.height * c.y,
...
var Gx = new Set(["absolute", "fixed"]);
function Yx(t, e) {
    let n = br(t, !0, e === "fixed"),
        r = n.top + t.clientTop,
...
function xh(t, e, n) {
    let r;
    if (e === "viewport") r = qx(t, n);
    else if (e === "document") r = Jx(ot(t));
    else if (Fe(e)) r = Yx(e, n);
    else {
        let o = Ch(t);
...
function vh(t, e) {
    let n = St(t);
    return n === e || !Fe(n) || nn(n)
        ? !1
        : $e(n).position === "fixed" || vh(n, e);
}
function Xx(t, e) {
    let n = e.get(t);
    if (n) return n;
    let r = ci(t, [], !1).filter((l) => Fe(l) && tn(l) !== "body"),
        o = null,
        i = $e(t).position === "fixed",
        s = i ? St(t) : t;
    for (; Fe(s) && !nn(s); ) {
        let l = $e(s),
            a = di(s);
    ...
    let { element: e, boundary: n, rootBoundary: r, strategy: o } = t,
        ...
        a = s.reduce(
            (c, u) => {
                let d = xh(e, u, o);
                return (
                    (c.top = fe(d.top, c.top)),
                    (c.right = ze(d.right, c.right)),
                    (c.bottom = ze(d.bottom, c.bottom)),
                    (c.left = fe(d.left, c.left)),
                    c
                );
            },
            xh(e, l, o),
...
function ew(t, e, n) {
    ...
    if (r || (!r && !i))
        if (((tn(e) !== "body" || Tn(o)) && (l = yr(e)), r)) {
            let h = br(e, !0, i, e);
            (a.x = h.x + e.clientLeft), (a.y = h.y + e.clientTop);
        } else o && c();
    i && !r && o && c();
    let u = o && !r && !i ? Mh(o, l) : _e(0),
...
function wh(t, e) {
    if (!Ke(t) || $e(t).position === "fixed") return null;
    if (e) return e(t);
...
function Th(t, e) {
    ...
    if (!Ke(t)) {
        let o = St(t);
        for (; o && !nn(o); ) {
            if (Fe(o) && !ql(o)) return o;
            o = St(o);
        }
        return n;
    }
    let r = wh(t, e);
    for (; r && gh(r) && ql(r); ) r = wh(r, e);
    return r && nn(r) && ql(r) && !di(r) ? n : r || yh(t) || n;
}
var tw = async function (t) {
    let e = this.getOffsetParent || Th,
        n = this.getDimensions,
        r = await n(t.floating);
    return {
        reference: ew(t.reference, await e(t.floating), t.strategy),
...
var Ph = (t, e) => {
        gi(
            {
                getBoundingClientRect: () => {
                    let { from: r, to: o } = t.state.selection,
                        i = t.view.coordsAtPos(r),
                        s = t.view.coordsAtPos(o);
                    return {
    ...
    Ih = ({ mergeTags: t, noMergeTagSearchResultsMessage: e }) => ({
        items: ({ query: n }) =>
            t.filter((r) =>
                r.toLowerCase().replace(/\s/g, "").includes(n.toLowerCase()),
            ),
        render: () => {
            let n,
                r = 0,
                ...
                i = () => {
                    ...
                    return (
                        (d.className = "fi-dropdown-panel fi-dropdown-list"), d
                    );
                },
                s = () => {
                    if (!n || !o) return;
                    let d = o.items || [];
                    if (((n.innerHTML = ""), d.length))
                        d.forEach((f, h) => {
                ...
                a = () => {
                    ...
                    let d = o.items || [];
                    d.length !== 0 &&
                        ((r = (r + d.length - 1) % d.length), s());
                },
                c = () => {
                    if (!o) return;
                    let d = o.items || [];
                    d.length !== 0 && ((r = (r + 1) % d.length), s());
                },
                u = () => {
                    l(r);
                };
            return {
                onStart: (d) => {
                    (o = d),
                        ...
                        d.clientRect && Ph(d.editor, n);
                },
                onUpdate: (d) => {
                    (o = d), (r = 0), s(), d.clientRect && Ph(d.editor, n);
                },
                onKeyDown: (d) =>
                    d.event.key === "Escape"
...
var Lh = async ({
    customExtensionUrls: t,
    deleteCustomBlockButtonIconHtml: e,
    editCustomBlockButtonIconHtml: n,
    editCustomBlockUsing: r,
    insertCustomBlockUsing: o,
    key: i,
    mergeTags: s,
    noMergeTagSearchResultsMessage: l,
    placeholder: a,
    statePath: c,
    uploadingFileMessage: u,
    $wire: d,
}) => [
    gd,
    yd,
    ...
    Od,
    Nd,
    Dd.configure({ inline: !0 }),
    Pd,
    Gd.configure({ autolink: !0, openOnClick: !1 }),
    Ol,
    lf.configure({
        get$WireUsing: () => d,
        key: i,
    ...
    Rl,
    uf,
    df.configure({ placeholder: a }),
    ff,
    hf,
    pf,
    mf,
    Uf.configure({ table: { resizable: !0 } }),
    Jf,
    qf.configure({
    ...
    ...(
        await Promise.all(
            t.map(
                async (f) => (
                    new RegExp("^(?:[a-z+]+:)?//", "i").test(f) ||
                        (f = new URL(f, document.baseURI).href),
                    (await import(f)).default
                ),
            ),
        )
    ).flat(),
...
var iw = class {
        constructor({
            ...
            (this.preventHide = !1),
                ...
                (this.shouldShow = ({ view: l, state: a, from: c, to: u }) => {
                    let { doc: d, selection: f } = a,
                        { empty: h } = f,
                        p = !d.textBetween(c, u).length && lo(a.selection),
                ...
                (this.blurHandler = ({ event: l }) => {
                    ...
                    (l?.relatedTarget &&
                        ...
                        (l?.relatedTarget !== this.editor.view.dom &&
                            this.hide());
                }),
                (this.handleDebouncedUpdate = (l, a) => {
                    let c = !a?.selection.eq(l.state.selection),
                        u = !a?.doc.eq(l.state.doc);
                    (!c && !u) ||
                ...
                (this.updateDelay = r),
                (this.resizeDelay = o),
                (this.floatingUIOptions = { ...this.floatingUIOptions, ...s }),
        ...
        get middlewares() {
            ...
            return (
                ...
                this.floatingUIOptions.arrow &&
                    t.push(Rh(this.floatingUIOptions.arrow)),
        ...
        updatePosition() {
            let { selection: t } = this.editor.state,
                e = {
                    getBoundingClientRect: () => Fu(this.view, t.from, t.to),
                };
            if (t instanceof K) {
                let { $anchorCell: n, $headCell: r } = t,
                    o = n ? n.pos : r.pos,
                    i = r ? r.pos : n.pos,
                    s = this.view.nodeDOM(o),
                    l = this.view.nodeDOM(i);
                if (!s || !l) return;
                let a =
                    s === l
        ...
        update(t, e) {
            ...
            let o = !e?.selection.eq(t.state.selection),
                i = !e?.doc.eq(t.state.doc);
        ...
        show() {
            ...
            this.isVisible ||
                ...
                (t = this.view.dom.parentElement) == null ||
...
function sw({
    ...
    livewireId: c,
    mergeTags: u,
    noMergeTagSearchResultsMessage: d,
    placeholder: f,
    state: h,
    statePath: p,
    uploadingFileMessage: m,
    floatingToolbars: g,
}) {
    let y;
    return {
        ...
        async init() {
            (y = new nd({
                ...
                extensions: await Lh({
                    ...
                    insertCustomBlockUsing: (b, x = null) =>
                        this.$wire.mountAction(
                            "customBlock",
                            { id: b, dragPosition: x, mode: "insert" },
                            { schemaComponent: o },
                        ),
                    key: o,
                    mergeTags: u,
                ...
                Object.keys(g).forEach((b) => {
                    let x = this.$refs[`floatingToolbar::${b}`];
                    if (!x) {
                        console.warn(`Floating toolbar [${b}] not found.`);
                        return;
                    }
                    y.registerPlugin(
                        Yl({
                            editor: y,
                            element: x,
                            pluginKey: `floatingToolbar::${b}`,
                            shouldShow: ({ editor: C }) =>
                                C.isFocused && C.isActive(b),
                ...
                y.on("update", ({ editor: b }) =>
                    this.$nextTick(() => {
                        (this.editorUpdatedAt = Date.now()),
                            (this.state = b.getJSON()),
                ...
                y.on("selectionUpdate", ({ transaction: b }) => {
                    (this.editorUpdatedAt = Date.now()),
                        (this.editorSelection = b.selection.toJSON());
                }),
                l && y.on("blur", () => this.$wire.commit()),
                this.$watch("state", () => {
                    if (!this.shouldUpdateState) {
                        this.shouldUpdateState = !0;
                        return;
                    }
                    y.commands.setContent(this.state);
                }),
                window.addEventListener("run-rich-editor-commands", (b) => {
                    b.detail.livewireId === c &&
                        b.detail.key === o &&
                        this.runEditorCommands(b.detail);
                }),
                window.addEventListener("rich-editor-uploading-file", (b) => {
                    b.detail.livewireId === c &&
                        b.detail.key === o &&
                        ((this.isUploadingFile = !0), b.stopPropagation());
                }),
                window.addEventListener("rich-editor-uploaded-file", (b) => {
                    b.detail.livewireId === c &&
                        b.detail.key === o &&
                        ((this.isUploadingFile = !1), b.stopPropagation());
                }),
                window.dispatchEvent(
                    new CustomEvent(`schema-component-${c}-${o}-loaded`),
                );
        },
        getEditor() {
            return y;
        ...
        setEditorSelection(b) {
            b &&
                ((this.editorSelection = b),
                y
                    .chain()
                    .command(
                        ({ tr: x }) => (
                            x.setSelection(
                                E.fromJSON(y.state.doc, this.editorSelection),
                            ),
                            !0
                        ),
                    )
        ...
        runEditorCommands({ commands: b, editorSelection: x }) {
            this.setEditorSelection(x);
            let C = y.chain();
            b.forEach((S) => (C = C[S.name](...(S.arguments ?? [])))), C.run();
        },
        togglePanel(b = null) {
            if (this.isPanelActive(b)) {
                this.activePanel = null;
                return;
            }
            this.activePanel = b;
        },
        isPanelActive(b = null) {
            return b === null
                ? this.activePanel !== null
                : this.activePanel === b;
        },
